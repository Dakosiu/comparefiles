...
class LuaScriptInterface
{
	...
	private:
		...
		static int luaPlayerLockHealth(lua_State* L);
		static int luaPlayerLockMana(lua_State* L);
		static int luaPlayerLockInventory(lua_State* L);
		static int luaPlayerLockStats(lua_State* L);
		static int luaPlayerSetHolyLight(lua_State* L);
		...
		static int luaMoveEventMovementId(lua_State* L);
