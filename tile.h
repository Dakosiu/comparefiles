...
class Tile : public Cylinder
{
	public:
		...
		virtual const TileItemVector* getRefreshableItemList() const = 0;
		virtual TileItemVector* makeRefreshableItemList() = 0;
...
class DynamicTile : public Tile
{
	...
	public:
		...
		TileItemVector* getRefreshableItemList() final {
			return &refreshableItems;
		}
		const TileItemVector* getRefreshableItemList() const final {
			return &refreshableItems;
		}
		TileItemVector* makeRefreshableItemList() final {
			return &refreshableItems;
		}
