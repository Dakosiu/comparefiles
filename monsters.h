...
class MonsterType
{
	...
	public:
		...
		void createLoot(Container* corpse, Monster* monster);
		bool createLootContainer(Container* parent, const LootBlock& lootblock, Monster* monster);
		std::vector<Item*> createLootItem(const LootBlock& lootBlock, Monster* monster);
};
