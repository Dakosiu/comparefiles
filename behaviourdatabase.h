...
enum NpcBehaviourType_t
{
	...
	BEHAVIOUR_TYPE_MESSAGE_STRING, // get string in player message
	BEHAVIOUR_TYPE_TALKER_GUID, // get current customer GUID
	...
	BEHAVIOUR_TYPE_PLAYEREXISTS, // check if player exists
	...
	BEHAVIOUR_TYPE_LUA, // call a lua script file
};
...
class BehaviourDatabase
{
	...
	private:
		...
		std::string string;
		std::string player_string_value;
