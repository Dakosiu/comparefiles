	...
	function NpcHandler:addModule(module, initNpcName, greetCallback, farewellCallback, tradeCallback)
		if self.modules ~= nil then
			...
			if greetCallback == nil then
				--Spdlog.warn("[NpcHandler:addModule] - Greet callback is missing for npc with name: ".. self.npcName ..", setting to true")
				greetCallback = true
			end
			if farewellCallback == nil then
				--Spdlog.warn("[NpcHandler:addModule] - Farewell callback is missing for npc with name: ".. self.npcName ..", setting to true")
				farewellCallback = true
			end
			if tradeCallback == nil then
				--Spdlog.warn("[NpcHandler:addModule] - Trade callback is missing for npc with name: ".. self.npcName ..", setting to true")
				tradeCallback = true
			end
