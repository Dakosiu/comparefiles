		...
		offers = {
			{
				...
				price = 15,
				itemtype = 42321,
				description = "<i>Novice Helmet, this helmet its very good to start your journey on Zakaria OTS!</i>\n Test 1\n\n{character}{useicon}",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},
			{
				icons = { "Magic_Gold_Converter.png" },
				...
				price = 15,
				itemtype = 42322,
				description = "<i>Novice Armor, this armor its very good to start your journey on Zakaria OTS!</i>\n Test 1\n\n{character}{useicon}",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},			
			{
				icons = { "Magic_Gold_Converter.png" },
				...
				price = 15,
				itemtype = 42324,
				description = "<i>Novice Legs, these legs its very good to start your journey on Zakaria OTS!</i>\n Test 1\n\n{character}{useicon}",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},	
			{
				icons = { "Magic_Gold_Converter.png" },
				...
				price = 15,
				itemtype = 42325,
				description = "<i>Novice Boots, these boots its very good to start your journey on Zakaria OTS!</i>\n Test 1\n\n{character}{useicon}",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},
			{
				icons = { "Magic_Gold_Converter.png" },
				name = "Novice Helmet 2",
				price = 15,
				itemtype = 42329,
				description = "<i>Novice Helmet, this helmet its very good to start your journey on Zakaria OTS!</i>\n Test 1\n\n{character}{useicon}",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
	...
	
	{
		...
		offers = {
							
			{
				...
				price = 15,
				itemtype = 42326,
				description = "<i>Novice Amulet, this amulet its very good to start your journey on Zakaria OTS!</i>\n Test 1\n\n{character}{useicon}",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},						
			{
				icons = { "Magic_Gold_Converter.png" },
				...
				price = 15,
				itemtype = 42328,
				description = "<i>Novice Ring 2, this ring its very good to start your journey on Zakaria OTS!</i>\n Test 1\n\n{character}{useicon}",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},
			{
				icons = { "Magic_Gold_Converter.png" },
				...
				price = 15,
				itemtype = 42327,
				description = "<i>Novice Ring 1, this ring its very good to start your journey on Zakaria OTS!</i>\n Test 1\n\n{character}{useicon}",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},	
		}
	},
	
	{
		...
		offers = {
			{
				...
				price = 15,
				itemtype = 42334,
				description = "<i>Novice Mace, this mace its very good to start your journey on Zakaria OTS!</i>\n Test 1\n\n{character}{useicon}",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},	
			{
				icons = { "Magic_Gold_Converter.png" },
				...
				price = 15,
				itemtype = 42335,
				description = "<i>Novice Axe, this axe its very good to start your journey on Zakaria OTS!</i>\n Test 1\n\n{character}{useicon}",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},		
			{
				icons = { "Magic_Gold_Converter.png" },
				...
				price = 15,
				itemtype = 42336,
				description = "<i>Novice Sword, this sword its very good to start your journey on Zakaria OTS!</i>\n Test 1\n\n{character}{useicon}",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},	

			{
				...
				price = 15,
				itemtype = 42338,
				description = "<i>Novice Staff, this staff its very good to start your journey on Zakaria OTS!</i>\n Test 1\n\n{character}{useicon}",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},	

			{
				icons = { "Magic_Gold_Converter.png" },
				name = "Novice Slingshot",
				price = 15,
				itemtype = 42337,
				description = "<i>Novice Slingshot, this slingshot its very good to start your journey on Zakaria OTS!</i>\n Test 1\n\n{character}{useicon}",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},				
		...
		offers = {
						
			{
				...
				price = 15,
				itemtype = 42331,
				description = "<i>Novice Spellbook, this spellbook its very good to start your journey on Zakaria OTS!</i>\n Test 1\n\n{character}{useicon}",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},	
				...
				price = 15,
				itemtype = 42323,
				description = "<i>Novice Shield, these legs its very good to start your journey on Zakaria OTS!</i>\n Test 1\n\n{character}{useicon}",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},		
				{
				icons = { "Magic_Gold_Converter.png" },
				...
				price = 15,
				itemtype = 25303,
				description = "<i>Milk tooth, these legs its very good to start your journey on Zakaria OTS!</i>\n Test 1\n\n{character}{useicon}",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},			
				{
				icons = { "Magic_Gold_Converter.png" },
				...
				price = 15,
				itemtype = 31625,
				description = "<i>It gives 50% more max capacity!</i>\n Test 1\n\n{character}{useicon}",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},					
		}
	},
	...
	-- Exercise Weapons
	{
		...
		offers = {
			...
			},
			{
				...
				itemtype = 42381,
				charges = 14400,
				description = "<i>Use it to train your magic level on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} use it on an exercise dummy to train your shield level\n{info} usable 14400 times a piece",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},
		},
	},
