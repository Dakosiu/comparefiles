local config = {
    ...
    bossName = "dragon",
    bossPosition = Position(153, 2082, 7), -- Position where the boss will appear
    bossArea = {
        fromPos = Position(148, 2080, 7), -- Upper left corner of the room
        toPos = Position(157, 2084, 7), -- Lower right corner of the room
        entrancePos = Position(156, 2082, 7), -- Position where players will be teleported when they enter
        exitPosition = Position(156, 2097, 7) -- If the participants take too long they will be kicked from the room to this position
    },
    participantsAllowAnyCount = true, -- allow any valid number of participants to enter. example: 1,2,3 or 4
    participantsPos = {
        Position(156, 2092, 7), -- Player 1, this player should be the one to pull the lever
        Position(156, 2093, 7), -- Player 2
        Position(156, 2094, 7), -- Player 3
        Position(156, 2095, 7) -- Player 4
    },
    attempts = {
        level = 20, -- Level required to enter
        storage = 20000, -- Storage where we keep the waiting time
        seconds = 10000 -- 20 hours
    },
    createTeleportPos = Position(156, 2082, 7), -- Position where the teleport is created when the boss dies
    teleportToPosition = Position(156, 2097, 7), -- Position where the teleport created by the boss will take you when you die
