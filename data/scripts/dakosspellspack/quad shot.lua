...
local config = {
                 ...
                 ["Combats"] = { 
				                [1] = { effect = 307, distanceEffect = 98, type = COMBAT_PHYSICALDAMAGE, delay = 0 },
								[2] = { effect = 307, distanceEffect = 98, type = COMBAT_PHYSICALDAMAGE, delay = 1000 },
								[3] = { effect = 307, distanceEffect = 98, type = COMBAT_PHYSICALDAMAGE, delay = 2000 },
								[4] = { effect = 307, distanceEffect = 98, type = COMBAT_PHYSICALDAMAGE, delay = 3000 },
							   }
