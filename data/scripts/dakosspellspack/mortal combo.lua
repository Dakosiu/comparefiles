...
local config = {
                 ...
                 ["Combats"] = { 
				                [1] = { effect = 5, distanceEffect = 5, type = COMBAT_ENERGYDAMAGE, delay = 0 },
								[2] = { effect = 4, distanceEffect = 4, type = COMBAT_HOLYDAMAGE, delay = 200 },
								[3] = { effect = 5, distanceEffect = 5, type = COMBAT_ENERGYDAMAGE, delay = 300 },
								[4] = { effect = 4, distanceEffect = 4, type = COMBAT_ENERGY_DAMAGE, delay = 400 },
								[5] = { effect = 5, distanceEffect = 5, type = COMBAT_EARTHDAMAGE, delay = 500 },
							   }
...
spell:group("attack")
spell:id(112)
spell:name("Mortal Combo")
spell:words("mortal combo")
spell:level(900)
spell:mana(2200)
