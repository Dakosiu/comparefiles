local combat = {}
local config = {
                 ["Combo"] = { times = 4, delay = 100 }, 
                 ["Combats"] = { 
				                [1] = { effect = 12, distanceEffect = 5, type = COMBAT_ENERGYDAMAGE, delay = 0 },
								[2] = { effect = 12, distanceEffect = 5, type = COMBAT_HOLYDAMAGE, delay = 200 },
								[3] = { effect = 12, distanceEffect = 5, type = COMBAT_ENERGYDAMAGE, delay = 300 },
								[4] = { effect = 12, distanceEffect = 5, type = COMBAT_ENERGY_DAMAGE, delay = 400 },
								[5] = { effect = 12, distanceEffect = 5, type = COMBAT_EARTHDAMAGE, delay = 500 },
							   }
...
spell:id(112)
spell:name("Energy Combo")
spell:words("energy combo")
spell:level(650)
spell:mana(1300)
