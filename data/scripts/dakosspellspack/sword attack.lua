...
local config = {
                 ...
                 ["Combats"] = { 
				                [1] = { effect = 4, distanceEffect = 25, type = COMBAT_PHYSICALDAMAGE, delay = 0 },
								[2] = { effect = 1, distanceEffect = 25, type = COMBAT_PHYSICALDAMAGE, delay = 200 },
								[3] = { effect = 4, distanceEffect = 25, type = COMBAT_PHYSICALDAMAGE, delay = 400 },
								[4] = { effect = 1, distanceEffect = 25, type = COMBAT_PHYSICALDAMAGE, delay = 600 },
							   }
