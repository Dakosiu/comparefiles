...
local config = {
                 ...
                 ["Combats"] = { 
				                [1] = { effect = 44, distanceEffect = 37, type = COMBAT_ENERGYDAMAGE, delay = 0 },
								[2] = { effect = 44, distanceEffect = 37, type = COMBAT_HOLYDAMAGE, delay = 200 },
								[3] = { effect = 44, distanceEffect = 37, type = COMBAT_ENERGYDAMAGE, delay = 300 },
								[4] = { effect = 44, distanceEffect = 37, type = COMBAT_ENERGY_DAMAGE, delay = 400 },
								[5] = { effect = 44, distanceEffect = 37, type = COMBAT_EARTHDAMAGE, delay = 500 },
							   }
...
spell:group("attack")
spell:id(112)
spell:name("Ice Combo")
spell:words("ice combo")
spell:level(650)
spell:mana(1300)
