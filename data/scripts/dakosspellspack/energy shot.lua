local combat = {}
local config = {
                 ["Combo"] = { times = 3, delay = 200 }, 
                 ["Combats"] = { 
				                [1] = { effect = 0, distanceEffect = 36, type = COMBAT_ENERGYDAMAGE, delay = 0 },
								[2] = { effect = 0, distanceEffect = 37, type = COMBAT_HOLYDAMAGE, delay = 200 },
								[3] = { effect = 38, distanceEffect = 38, type = COMBAT_ENERGYDAMAGE, delay = 300 },
								[4] = { effect = 12, distanceEffect = 39, type = COMBAT_ENERGY_DAMAGE, delay = 400 },
								[5] = { effect = 6, distanceEffect = 33, type = COMBAT_EARTHDAMAGE, delay = 500 },
							   }
...
spell:group("attack")
spell:id(112)
spell:name("Energy Shot")
spell:words("energy shot")
spell:level(15)
spell:mana(20)
