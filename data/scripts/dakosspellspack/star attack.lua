local combat = {}
local config = {
                 ["Combo"] = { times = 3, delay = 1000 }, 
                 ["Combats"] = { 
				                [1] = { effect = 40, distanceEffect = 20, type = COMBAT_EARTHDAMAGE, delay = 0 },
								[2] = { effect = 9, distanceEffect = 19, type = COMBAT_EARTHDAMAGE, delay = 200 },
								[3] = { effect = 40, distanceEffect = 20, type = COMBAT_EARTHDAMAGE, delay = 400 },
								[4] = { effect = 9, distanceEffect = 19, type = COMBAT_EARTHDAMAGE, delay = 600 },
							   }
...
spell:group("attack")
spell:id(112)
spell:name("Star Attack")
spell:words("star attack")
spell:level(15)
spell:mana(20)
