local config = {
	[5908] = {
		...
		[11343] = {
			{chance = 1000, newItem = 11346, desc = "This little figurine of a goddess was masterfully sculpted by |PLAYERNAME|."},
			{chance = 5000, newItem = 11345, desc = "This little figurine made by |PLAYERNAME| has some room for improvement."},
			{chance = 10000, newItem = 11344, desc = "This shoddy work was made by |PLAYERNAME|."}
		},
