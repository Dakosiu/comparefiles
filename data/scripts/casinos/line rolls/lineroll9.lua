local config = {
    ...
    rouletteOptions = {
        ...
        rouletteStorage = 666563 -- required storage to avoid player abuse (if they logout/die before roulette finishes.. they can spin again for free)
    },
    prizePool = {
        {itemId = 41530, count = {5, 50},   chance = 10000}, -- dark energy coins {itemId = itemid, count = {min, max}, chance = chance/10000} (crystal coins)
        {itemId = 41019, count = {1, 2},    chance = 9000 }, -- global skilling boost
        {itemId = 41611, count = {2, 10},    chance = 8500 }, -- stats orb
        {itemId = 26377, count = {2, 5},    chance = 7500 }, -- warrior coins bag
        {itemId = 28436, count = {10, 20},   chance = 6500 }, -- exp pearls bag -- runes are given as stackable items, even tho they have 'charges'
        {itemId = 40685, count = {1, 1}, chance = 5000 }, -- green surprise box   -- items with 'charges' and have 'showCharges' in items.xml will be given charges
        {itemId = 24828, count = {1, 1},    chance = 4000 }, -- pandorus pick 80%
		{itemId = 18423, count = {2, 5},    chance = 1500 }, -- grand event tokens
        {itemId = 31950, count = {1, 1},    chance = 3000 }, -- purple time token
        {itemId = 41110, count = {1, 1},    chance = 500  }  -- Main item 
    ...
    roulettePositions = { -- hard-coded to 7 positions.
        ...
        Position(73, 2052, 5),
        Position(74, 2052, 5),
        Position(75, 2052, 5), -- position 4 in this list is hard-coded to be the reward location, which is the item given to the player
        Position(76, 2052, 5),
        Position(77, 2052, 5),
        Position(78, 2052, 5),
    }
