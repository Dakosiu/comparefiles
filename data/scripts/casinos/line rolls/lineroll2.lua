local config = {
    ...
    rouletteOptions = {
        ...
        rouletteStorage = 666556 -- required storage to avoid player abuse (if they logout/die before roulette finishes.. they can spin again for free)
    },
    prizePool = {
        {itemId = 2152, count = {1, 100},   chance = 10000}, -- {itemId = itemid, count = {min, max}, chance = chance/10000} (crystal coins)
        {itemId = 2195, count = {1, 1},    chance = 9000 }, -- BOH
        {itemId = 8306, count = {1, 1},    chance = 8500 }, -- slot gem small
        {itemId = 2173, count = {1, 1},    chance = 7500 }, -- AOL
        {itemId = 21401, count = {1, 1},   chance = 6500 }, -- dragon tear bp+1 -- runes are given as stackable items, even tho they have 'charges'
        {itemId = 2160, count = {1, 20}, chance = 5000 }, -- CC   -- items with 'charges' and have 'showCharges' in items.xml will be given charges
        {itemId = 40554, count = {1, 10},    chance = 4000 }, -- warrior coins
        {itemId = 2472, count = {1, 1},    chance = 3000 }, -- magic plate armor
        {itemId = 35427, count = {1, 50},    chance = 1500 }, -- event stones
        {itemId = 41078, count = {1, 1},    chance = 500  }  -- Main item 
    ...
    roulettePositions = { -- hard-coded to 7 positions.
        ...
        Position(65, 2062, 7),
        Position(66, 2062, 7),
        Position(67, 2062, 7), -- position 4 in this list is hard-coded to be the reward location, which is the item given to the player
        Position(68, 2062, 7),
        Position(69, 2062, 7),
        Position(70, 2062, 7),
    }
