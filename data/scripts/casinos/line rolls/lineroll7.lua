local config = {
    ...
    rouletteOptions = {
        ...
        rouletteStorage = 666561 -- required storage to avoid player abuse (if they logout/die before roulette finishes.. they can spin again for free)
    },
    prizePool = {
        {itemId = 35427, count = {50, 100},   chance = 10000}, -- event stones {itemId = itemid, count = {min, max}, chance = chance/10000} (crystal coins)
        {itemId = 40554, count = {50, 100},    chance = 9000 }, -- warrior coins
        {itemId = 18422, count = {50, 100},    chance = 8500 }, -- event tokens
        {itemId = 27604, count = {5, 15},    chance = 7500 }, -- tp pots
        {itemId = 31949, count = {2, 5},   chance = 6500 }, -- green time token -- runes are given as stackable items, even tho they have 'charges'
        {itemId = 26377, count = {1, 2}, chance = 5000 }, -- warrior coins bag   -- items with 'charges' and have 'showCharges' in items.xml will be given charges
        {itemId = 41533, count = {1, 1},    chance = 4000 }, -- 7 days pacc scroll
        {itemId = 41530, count = {1, 10},    chance = 3000 }, -- dark energy coin
        {itemId = 18423, count = {1, 1},    chance = 1500 }, -- grand event token
        {itemId = 41075, count = {1, 1},    chance = 500  }  -- Main item 
    ...
    roulettePositions = { -- hard-coded to 7 positions.
        ...
        Position(57, 2052, 5),
        Position(58, 2052, 5),
        Position(59, 2052, 5), -- position 4 in this list is hard-coded to be the reward location, which is the item given to the player
        Position(60, 2052, 5),
        Position(61, 2052, 5),
        Position(62, 2052, 5),
    }
