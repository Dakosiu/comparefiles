local config = {
    ...
    rouletteOptions = {
        ...
        rouletteStorage = 666555 -- required storage to avoid player abuse (if they logout/die before roulette finishes.. they can spin again for free)
    },
    prizePool = {
        {itemId = 2148, count = {1, 100},   chance = 10000}, -- {itemId = itemid, count = {min, max}, chance = chance/10000} (crystal coins)
        ...
        {itemId = 2173, count = {1, 1},   chance = 6500 }, -- AOL -- runes are given as stackable items, even tho they have 'charges'
        {itemId = 2160, count = {1, 10}, chance = 5000 }, -- CC   -- items with 'charges' and have 'showCharges' in items.xml will be given charges
        {itemId = 40554, count = {1, 3},    chance = 4000 }, -- warrior coins
        {itemId = 2470, count = {1, 1},    chance = 3000 }, -- golden legs
        {itemId = 35427, count = {1, 25},    chance = 1500 }, -- event stones
        {itemId = 21699, count = {1, 1},    chance = 500  }  -- Main item 
    ...
    roulettePositions = { -- hard-coded to 7 positions.
        ...
        Position(57, 2062, 7),
        Position(58, 2062, 7),
        Position(59, 2062, 7), -- position 4 in this list is hard-coded to be the reward location, which is the item given to the player
        Position(60, 2062, 7),
        Position(61, 2062, 7),
        Position(62, 2062, 7),
    }
