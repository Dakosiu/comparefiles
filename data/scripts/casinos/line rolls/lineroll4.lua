local config = {
    ...
    rouletteOptions = {
        ...
        rouletteStorage = 666558 -- required storage to avoid player abuse (if they logout/die before roulette finishes.. they can spin again for free)
    },
    prizePool = {
        {itemId = 2160, count = {1, 100},   chance = 10000}, -- {itemId = itemid, count = {min, max}, chance = chance/10000} (crystal coins)
        {itemId = 21401, count = {1, 1},    chance = 9000 }, -- bp +1
        {itemId = 26179, count = {1, 2},    chance = 8500 }, -- energy ball
        {itemId = 27604, count = {1, 1},    chance = 7500 }, -- tp pot
        {itemId = 8302, count = {1, 1},   chance = 6500 }, -- mid slot gem -- runes are given as stackable items, even tho they have 'charges'
        {itemId = 8300, count = {25, 100}, chance = 5000 }, -- best slot gem   -- items with 'charges' and have 'showCharges' in items.xml will be given charges
        {itemId = 40554, count = {10, 50},    chance = 4000 }, -- warrior coins
        {itemId = 40554, count = {20, 100},    chance = 3000 }, -- warrior coins
        {itemId = 18422, count = {1, 5},    chance = 1500 }, -- event stones
        {itemId = 41077, count = {1, 1},    chance = 500  }  -- Main item 
    ...
    roulettePositions = { -- hard-coded to 7 positions.
        ...
        Position(57, 2057, 6),
        Position(58, 2057, 6),
        Position(59, 2057, 6), -- position 4 in this list is hard-coded to be the reward location, which is the item given to the player
        Position(60, 2057, 6),
        Position(61, 2057, 6),
        Position(62, 2057, 6),
    }
