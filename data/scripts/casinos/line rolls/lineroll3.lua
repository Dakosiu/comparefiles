local config = {
    actionId = 63002, -- on lever
    lever = {
        left = 1945,
        right = 1946
    },
    playItem = {
        itemId = 35427, -- item required to pull lever
        count = 80
    },
    rouletteOptions = {
        ...
        rouletteStorage = 666557 -- required storage to avoid player abuse (if they logout/die before roulette finishes.. they can spin again for free)
    },
    prizePool = {
        {itemId = 2160, count = {1, 25},   chance = 10000}, -- {itemId = itemid, count = {min, max}, chance = chance/10000} (crystal coins)
        {itemId = 2173, count = {1, 1},    chance = 9000 }, -- AOL
        {itemId = 8306, count = {1, 1},    chance = 8500 }, -- small slot gem
        {itemId = 8302, count = {1, 1},    chance = 7500 }, -- medium slot gem
        {itemId = 30524, count = {1, 1},   chance = 6500 }, -- mid bonus gem -- runes are given as stackable items, even tho they have 'charges'
        {itemId = 2160, count = {25, 100}, chance = 5000 }, -- CC   -- items with 'charges' and have 'showCharges' in items.xml will be given charges
        {itemId = 40554, count = {1, 20},    chance = 4000 }, -- warrior coins
        {itemId = 40554, count = {10, 50},    chance = 3000 }, -- warrior coins
        {itemId = 35427, count = {1, 100},    chance = 1500 }, -- event stones
        {itemId = 41079, count = {1, 1},    chance = 500  }  -- Main item 
    ...
    roulettePositions = { -- hard-coded to 7 positions.
        ...
        Position(73, 2062, 7),
        Position(74, 2062, 7),
        Position(75, 2062, 7), -- position 4 in this list is hard-coded to be the reward location, which is the item given to the player
        Position(76, 2062, 7),
        Position(77, 2062, 7),
        Position(78, 2062, 7),
    }
