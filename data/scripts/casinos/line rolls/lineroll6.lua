local config = {
    actionId = 63005, -- on lever
    lever = {
        left = 1945,
        right = 1946
    },
    playItem = {
        itemId = 18422, -- item required to pull lever
        count = 40
    },
    rouletteOptions = {
        ...
        rouletteStorage = 666560 -- required storage to avoid player abuse (if they logout/die before roulette finishes.. they can spin again for free)
    },
    prizePool = {
        {itemId = 18422, count = {1, 3},   chance = 10000}, -- event tokens {itemId = itemid, count = {min, max}, chance = chance/10000} (crystal coins)
        {itemId = 21401, count = {1, 3},    chance = 9000 }, -- bp +1
        {itemId = 18422, count = {1, 5},    chance = 8500 }, -- event tokens
        {itemId = 41611, count = {1, 1},    chance = 7500 }, -- stat orb
        {itemId = 40554, count = {10, 30},   chance = 6500 }, -- warrior coins -- runes are given as stackable items, even tho they have 'charges'
        {itemId = 30525, count = {1, 1}, chance = 5000 }, -- best bonus gem   -- items with 'charges' and have 'showCharges' in items.xml will be given charges
        {itemId = 40554, count = {70, 100},    chance = 4000 }, -- warrior coins
        {itemId = 41529, count = {2, 5},    chance = 3000 }, -- amber coins
        {itemId = 18422, count = {1, 20},    chance = 1500 }, -- event tokens
        {itemId = 41076, count = {1, 1},    chance = 500  }  -- Main item 
    ...
    roulettePositions = { -- hard-coded to 7 positions.
        ...
        Position(73, 2057, 6),
        Position(74, 2057, 6),
        Position(75, 2057, 6), -- position 4 in this list is hard-coded to be the reward location, which is the item given to the player
        Position(76, 2057, 6),
        Position(77, 2057, 6),
        Position(78, 2057, 6),
    }
