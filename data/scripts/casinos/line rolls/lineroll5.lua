local config = {
    ...
    rouletteOptions = {
        ...
        rouletteStorage = 666559 -- required storage to avoid player abuse (if they logout/die before roulette finishes.. they can spin again for free)
    },
    prizePool = {
        {itemId = 2160, count = {30, 100},   chance = 10000}, -- {itemId = itemid, count = {min, max}, chance = chance/10000} (crystal coins)
        {itemId = 27604, count = {1, 1},    chance = 9000 }, -- Tp pot
        {itemId = 41611, count = {1, 1},    chance = 8500 }, -- stat orb
        {itemId = 28436, count = {1, 1},    chance = 7500 }, -- exp bag
        {itemId = 31949, count = {1, 1},   chance = 6500 }, -- green time token -- runes are given as stackable items, even tho they have 'charges'
        {itemId = 41529, count = {1, 2}, chance = 5000 }, -- amber coin   -- items with 'charges' and have 'showCharges' in items.xml will be given charges
        {itemId = 40554, count = {20, 70},    chance = 4000 }, -- warrior coins
        {itemId = 40554, count = {50, 100},    chance = 3000 }, -- warrior coins
        {itemId = 18422, count = {1, 10},    chance = 1500 }, -- event stones
        {itemId = 41057, count = {1, 1},    chance = 500  }  -- Main item 
    ...
    roulettePositions = { -- hard-coded to 7 positions.
        ...
        Position(65, 2057, 6),
        Position(66, 2057, 6),
        Position(67, 2057, 6), -- position 4 in this list is hard-coded to be the reward location, which is the item given to the player
        Position(68, 2057, 6),
        Position(69, 2057, 6),
        Position(70, 2057, 6),
    }
