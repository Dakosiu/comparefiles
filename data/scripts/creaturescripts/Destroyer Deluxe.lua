local config = {
	{chance = 10, monster = "Destroyer", message = "what im doing here  ? :O!"},
	{chance = 100, monster = "Destroyer Deluxe", message = "hhhhhhh im back!"}
}

local creatureevent = CreatureEvent("destroyerdeluxe")
