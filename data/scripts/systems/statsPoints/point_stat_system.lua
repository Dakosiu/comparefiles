...
local config = {
	Health = {
		[1] = { Name = "Health Grade 1", Price = 2, Gain = 250, Type = "HP", Limit = 25000 },
		[2] = { Name = "Health Grade 2", Price = 4, Gain = 400, Type = "HP", Limit = 65000 },
		[3] = { Name = "Health Grade 3", Price = 8, Gain = 1000, Type = "HP", Limit = 165000 },
		[4] = { Name = "Health Grade 4", Price = 15, Gain = 2000, Type = "HP", Limit = 365000 },
	...
	Mana = {
		...
		[3] = { Name = "Mana Grade 3", Price = 4, Gain = 1000, Type = "MP", Limit = 165000 },
		[4] = { Name = "Mana Grade 4", Price = 8, Gain = 2000, Type = "MP", Limit = 365000 },
		[5] = { Name = "Mana Grade 5", Price = 15, Gain = 4000, Type = "MP", Limit = 765000 },
	},
	Attack = {
		[1] = { Name = "Bonus Damage Grade 1", Price = 5, Gain = 1, Type = "%", Limit = 10 }, -- 10
		[2] = { Name = "Bonus Damage Grade 2", Price = 10, Gain = 1, Type = "%", Limit = 30 }, -- 20 
		[3] = { Name = "Bonus Damage Grade 3", Price = 20, Gain = 1, Type = "%", Limit = 80 }, -- 50
		[4] = { Name = "Bonus Damage Grade 4", Price = 30, Gain = 1, Type = "%", Limit = 130 }, -- 50
		[5] = { Name = "Bonus Damage Grade 5", Price = 40, Gain = 1, Type = "%", Limit = 230 }, -- 100
	},
	Healing = {
		[1] = { Name = "Healing Grade 1", Price = 1, Gain = 1, Type = "%", Limit = 25 }, -- 25
		[2] = { Name = "Healing Grade 2", Price = 2, Gain = 1, Type = "%", Limit = 50 }, -- 25
		[3] = { Name = "Healing Grade 3", Price = 4, Gain = 1, Type = "%", Limit = 75 }, --25
		[4] = { Name = "Healing Grade 4", Price = 6, Gain = 1, Type = "%", Limit = 150 }, -- 75???
		[5] = { Name = "Healing Grade 5", Price = 8, Gain = 1, Type = "%", Limit = 250 },
	},
	CriticalChance = {
		[1] = { Name = "Critical Chance Grade 1", Price = 5, Gain = 1, Type = "%", Limit = 2 },
		[2] = { Name = "Critical Chance Grade 2", Price = 10, Gain = 1, Type = "%", Limit = 4 },
		[3] = { Name = "Critical Chance Grade 3", Price = 15, Gain = 1, Type = "%", Limit = 6 },
		[4] = { Name = "Critical Chance Grade 4", Price = 20, Gain = 1, Type = "%", Limit = 8 },
		[5] = { Name = "Critical Chance Grade 5", Price = 30, Gain = 1, Type = "%", Limit = 10 },
	},
	CriticalDamage = {
		[1] = { Name = "Critical Damage Grade 1", Price = 2, Gain = 1, Type = "%", Limit = 5 },
		[2] = { Name = "Critical Damage Grade 2", Price = 4, Gain = 1, Type = "%", Limit = 15 },
		[3] = { Name = "Critical Damage Grade 3", Price = 8, Gain = 1, Type = "%", Limit = 65 },
		[4] = { Name = "Critical Damage Grade 4", Price = 15, Gain = 1, Type = "%", Limit = 130 },
		[5] = { Name = "Critical Damage Grade 5", Price = 20, Gain = 1, Type = "%", Limit = 260 },
	},
	BonusAttackSpeed = {
		[1] = { Name = "Attack Speed Grade 1", Price = 1, Gain = 5, Type = "ms", Limit = 500 }, -- 1400 attack speed (from normal(2000) to max of this)
		...
		[4] = { Name = "Attack Speed Grade 4", Price = 8, Gain = 10, Type = "ms", Limit = 1900 },
	},
	ProtectionAll = {
		[1] = { Name = "Protection All Grade 1", Price = 10, Gain = 1, Type = "%", Limit = 5 },
		[2] = { Name = "Protection All Grade 2", Price = 20, Gain = 1, Type = "%", Limit = 10 },
		[3] = { Name = "Protection All Grade 3", Price = 30, Gain = 1, Type = "%", Limit = 15 },
		[4] = { Name = "Protection All Grade 4", Price = 40, Gain = 1, Type = "%", Limit = 20 },
		[4] = { Name = "Protection All Grade 4", Price = 50, Gain = 1, Type = "%", Limit = 25 },
	},
	Reflection = {
		[1] = { Name = "Reflection Grade 1", Price = 5, Gain = 1, Type = "%", Limit = 10 },
		[2] = { Name = "Reflection Grade 2", Price = 10, Gain = 1, Type = "%", Limit = 30 },
		[3] = { Name = "Reflection Grade 3", Price = 20, Gain = 1, Type = "%", Limit = 80 },
		[4] = { Name = "Reflection Grade 4", Price = 30, Gain = 1, Type = "%", Limit = 130 },
		[5] = { Name = "Reflection Grade 5", Price = 40, Gain = 1, Type = "%", Limit = 200 },
	},
	Dodge = {
	...
	Speed = {
		[1] = { Name = "Walking Speed Grade 1", Price = 1, Gain = 5, Type = " Points", Limit = 50 },
		[2] = { Name = "Walking Speed Grade 2", Price = 3, Gain = 10, Type = " Points", Limit = 100 },
		[3] = { Name = "Walking Speed Grade 3", Price = 6, Gain = 10, Type = " Points", Limit = 200 },
		[4] = { Name = "Walking Speed Grade 4", Price = 15, Gain = 10, Type = " Points", Limit = 400 },
		[5] = { Name = "Walking Speed Grade 5", Price = 20, Gain = 10, Type = " Points", Limit = 500 },
	},
	TrappedEnergy = {
		[1] = { Name = "Trapped Energy Grade 1", Price = 10, Gain = 1, Type = "%", Limit = 1 },
		[2] = { Name = "Trapped Energy Grade 2", Price = 20, Gain = 1, Type = "%", Limit = 2 },
		[3] = { Name = "Trapped Energy Grade 3", Price = 40, Gain = 1, Type = "%", Limit = 3 },
		[4] = { Name = "Trapped Energy Grade 4", Price = 80, Gain = 1, Type = "%", Limit = 4 },
		[5] = { Name = "Trapped Energy Grade 5", Price = 160, Gain = 1, Type = "%", Limit = 5 },
	},
	ExpRate = {
	...
	ManaLeechChance = {
		[1] = { Name = "Mana Leech Chance Grade 1", Price = 5, Gain = 1, Type = "%", Limit = 2 },
		[2] = { Name = "Mana Leech Chance Grade 2", Price = 10, Gain = 1, Type = "%", Limit = 4 },
		[3] = { Name = "Mana Leech Chance Grade 3", Price = 15, Gain = 1, Type = "%", Limit = 6 },
		[4] = { Name = "Mana Leech Chance Grade 4", Price = 20, Gain = 1, Type = "%", Limit = 8 },
		[5] = { Name = "Mana Leech Chance Grade 5", Price = 30, Gain = 1, Type = "%", Limit = 10 },
	},
	ManaLeechAmount = {
	...
	LifeLeechChance = {
		[1] = { Name = "Life Leech Chance Grade 1", Price = 5, Gain = 1, Type = "%", Limit = 2 },
		[2] = { Name = "Life Leech Chance Grade 2", Price = 10, Gain = 1, Type = "%", Limit = 4 },
		[3] = { Name = "Life Leech Chance Grade 3", Price = 15, Gain = 1, Type = "%", Limit = 6 },
		[4] = { Name = "Life Leech Chance Grade 4", Price = 20, Gain = 1, Type = "%", Limit = 8 },
		[5] = { Name = "Life Leech Chance Grade 5", Price = 30, Gain = 1, Type = "%", Limit = 10 },
	},
	LifeLeechAmount = {
