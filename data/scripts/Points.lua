...
-- CREATE TABLE `players_chests` (
-- `id` int(11) NOT NULL AUTO_INCREMENT,
-- `name` varchar(32) NOT NULL,
-- `chests` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`chests`)),
-- PRIMARY KEY (id)
-- ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;



--function POINTS_SYSTEM:generateChest(player, storeTable, _isObtained)
    
	
	
	

-- function POINTS_SYSTEM:generateRewards(player, storeTable, _isObtained)
