...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 8, type = COMBAT_DEATHDAMAGE, minDamage = -1800, maxDamage = -1900, radius = 9, effect = CONST_ME_MORTAREA, target = false},
	...
	{name ="combat", interval = 3000, chance = 13, type = COMBAT_FIREDAMAGE, minDamage = -1300, maxDamage = -1800, range = 7, radius = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
	{name ="combat", interval = 3000, chance = 8, type = COMBAT_MANADRAIN, minDamage = -1600, maxDamage = -1700, radius = 10, effect = CONST_ME_ENERGYAREA, target = false},
	{name ="combat", interval = 2000, chance = 9, type = COMBAT_ENERGYDAMAGE, minDamage = -1400, maxDamage = -1800, length = 8, spread = 3, effect = CONST_ME_MAGIC_RED, target = false},
	-- poison
