...
monster.health = 310000
monster.maxHealth = 310000
monster.race = "fire"
monster.corpse = 4097
monster.speed = 265
monster.manaCost = 0
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 300, attack = 550},
	{name ="combat", interval = 1000, chance = 7, type = COMBAT_MANADRAIN, minDamage = -800, maxDamage = -1200, range = 7, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_POFF, target = false},
	...
	{name ="combat", interval = 1000, chance = 13, type = COMBAT_LIFEDRAIN, minDamage = -1400, maxDamage = -1700, radius = 8, effect = CONST_ME_LOSEENERGY, target = false},
	...
	{name ="combat", interval = 1000, chance = 34, type = COMBAT_FIREDAMAGE, minDamage = -500, maxDamage = -1900, range = 7, radius = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
	{name ="combat", interval = 1000, chance = 15, type = COMBAT_LIFEDRAIN, minDamage = -1500, maxDamage = -1850, length = 8, spread = 3, effect = CONST_ME_MAGIC_RED, target = false}
}
