local mType = Game.createMonsterType("Grieveserpent")
local monster = {}

monster.description = "Grieveserpent"
...
monster.attacks = {
	...
	{name ="Wrath of Nature", interval = 2000, chance = 16, minDamage = -2200, maxDamage = -2400},
	{name ="Terra Strike", interval = 2000, chance = 36, minDamage = -2200, maxDamage = -2500},
