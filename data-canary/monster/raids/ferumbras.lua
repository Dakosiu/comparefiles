...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_MANADRAIN, minDamage = -1500, maxDamage = -2700, range = 7, effect = CONST_ME_MAGIC_RED, target = false},
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_LIFEDRAIN, minDamage = -1300, maxDamage = -4500, length = 8, spread = 3, effect = CONST_ME_HITBYPOISON, target = false},
	{name ="combat", interval = 2000, chance = 21, type = COMBAT_LIFEDRAIN, minDamage = -2450, maxDamage = -4500, radius = 6, effect = CONST_ME_POFF, target = false},
	-- poison
	{name ="condition", type = CONDITION_POISON, interval = 2000, chance = 15, minDamage = -1220, maxDamage = -1240, range = 7, shootEffect = CONST_ANI_POISON, target = false},
	...
	-- fire
	{name ="condition", type = CONDITION_FIRE, interval = 3000, chance = 20, minDamage = -1500, maxDamage = -1800, range = 7, radius = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true}
}

monster.defenses = {
	defense = 120,
	armor = 100,
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_HEALING, minDamage = 9900, maxDamage = 15000, effect = CONST_ME_MAGIC_GREEN, target = false},
