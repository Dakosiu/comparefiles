...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 180, attack = 400},
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_DEATHDAMAGE, minDamage = -1700, maxDamage = -2500, length = 8, spread = 3, effect = CONST_ME_SMALLCLOUDS, target = true},
	{name ="combat", interval = 2000, chance = 28, type = COMBAT_PHYSICALDAMAGE, minDamage = 1110, maxDamage = -2750, range = 7, radius = 1, shootEffect = CONST_ANI_WHIRLWINDAXE, target = true}
}
