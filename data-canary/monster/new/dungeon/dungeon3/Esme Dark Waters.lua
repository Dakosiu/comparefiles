local mType = Game.createMonsterType("Esme Dark Waters")
local monster = {}

monster.description = "a Esme Dark Waters"
...
monster.attacks = {
	...
	{ name = "energy beam", interval = 2000, chance = 10, minDamage = -1150, maxDamage = -2110, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYAREA, target = false },
	{ name = "energy wave", interval = 2000, chance = 10, minDamage = -1101, maxDamage = -1180, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYAREA, target = false },
}
