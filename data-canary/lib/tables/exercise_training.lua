ExerciseWeaponsTable = {
	...
	-- SHIELD
	[42379] = { skill = SKILL_SHIELD},
	[42380] = { skill = SKILL_SHIELD},
	[42381] = { skill = SKILL_SHIELD},
	-- ROD
...
function ExerciseEvent(playerId, tilePosition, weaponId, dummyId)
	...
	if ExerciseWeaponsTable[weaponId].skill == SKILL_MAGLEVEL then
		...
		isMagic = true
	elseif ExerciseWeaponsTable[weaponId].skill == SKILL_SHIELD then
		skillRateDefault = skillLevelRate * 0.5
	end
