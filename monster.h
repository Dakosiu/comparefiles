...
class Monster final : public Creature
{
	public:
		...
		double getIncreaseLoot() {
			return increaseLoot;
		}
		
		double getIncreaseDefense() {
		    return increaseDefense;
        }
		
		double getIncreaseDamage() {
		    return increaseDamage;
        }
		
		double getIncreaseExperience() {
	...
	private:
		...
		uint32_t increasedDamage = 0;
		double increaseLoot = 0;
		double increaseDefense = 0;
		double increaseDamage = 0;
		double increaseExperience = 0;
