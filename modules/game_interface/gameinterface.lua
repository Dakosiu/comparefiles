...
function init()
 ...
 newUIContainer = g_ui.createWidget('newInterfaceHolder', modules.game_interface.getRootPanel())
 
  newUIContainer:recursiveGetChildById('minimap'):setImageShader("map_rainbow")
	
  if g_game.isOnline() then
    show()
  end
end
function returnHotkeysPanel()
	return newUIContainer:recursiveGetChildById('bottomPanel')
end
function getSpellsByVocation()
	local vocationMap = {
		[1] = "Kaer Disciple",
		[2] = "Jade Mystic",
		[3] = "Shepherd of Aureh",
  ...
  scheduleEvent(function()
		local getPlayer = g_game.getLocalPlayer()
			local vocationMap = {
				[1] = "leftPanel_Kaer",
				[2] = "leftPanel_Mystic",
				[3] = "leftPanel_Shepherd",
				[4] = "leftPanel_Kokao",
			}
		if getPlayer and vocationMap[getPlayer:getVocation()] then
			newUIContainer:recursiveGetChildById('leftPanel'):setImageSource("/images/newUI/"..vocationMap[getPlayer:getVocation()])
		end
	end,5)
  scheduleEvent(function() getSpellsByVocation() end , 5)
  refreshViewMode()
  show()
  scheduleEvent(function() getSpellsByVocation() end , 250)
...
function updateStretchShrink()
  ...
  gameMapPanel:setVisibleDimension({ width = 29, height = 19 })
