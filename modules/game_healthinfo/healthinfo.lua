...
function init()
  ...
  healthBar = modules.game_interface.getNewUI():recursiveGetChildById('healthBar')
  manaBar = modules.game_interface.getNewUI():recursiveGetChildById('manaBar')
  ...
  healthInfoWindow:setVisible(false)
end
...
function onHealthChange(localPlayer, health, maxHealth)
  ...
  healthBar:getChildById('healthBarValue'):setText(comma_value(health) .. ' / ' .. comma_value(maxHealth))
  healthBar:setTooltip(tr(healthTooltip, health, maxHealth))
  healthBar:getChildById('healthBarBackground'):setWidth(185 * ((health/maxHealth)))
  healthBar:getChildById('healthBarBackground'):setHeight(18)
...
function onManaChange(localPlayer, mana, maxMana)
  ...
  manaBar:getChildById('manaBarValue'):setText(comma_value(mana) .. ' / ' .. comma_value(maxMana))
  manaBar:setTooltip(tr(manaTooltip, mana, maxMana))
  manaBar:getChildById('manaBarBackground'):setWidth(185 * ((mana/maxMana)))
  manaBar:getChildById('healthBarBackground'):setHeight(18)
