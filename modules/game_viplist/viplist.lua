...
function init()
  ...
  vipButton:setOn(true)
    g_ui.loadUI('viplist')
    vipWindow = g_ui.createWidget('VipWindow', modules.game_interface.getRootPanel())
    vipWindow:setVisible(false)
...
function hide()
    vipWindow:hide()
  modules.game_interface.getNewUI():recursiveGetChildById('viplist'):setOn(false)
end
...
function show()
    ...
    vipWindow:raise()
    vipWindow:focus()
  modules.game_interface.getNewUI():recursiveGetChildById('viplist'):setOn(true)
end

function toggle()
  local widget = modules.game_interface.getNewUI():recursiveGetChildById('viplist')
  if widget:isOn() then
    widget:setOn(false)
	hide()
  else
...
function addVip()
  g_game.addVip(addVipWindow:recursiveGetChildById('name'):getText())
  destroyAddWindow()
end

function addVipButton()
  g_game.addVip(vipWindow:recursiveGetChildById('addText'):getText())
  destroyAddWindow()
end
