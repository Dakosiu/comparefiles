...
enum itemAttrTypes : uint32_t {
	...
	ITEM_ATTRIBUTE_EXTRA_ARMOR = 1 << 28,
	ITEM_ATTRIBUTE_EXTRA_DEFENSE = 1 << 29,
	ITEM_ATTRIBUTE_EXTRA_ATTACK = 1 << 30,
	
/* 	ITEM_ATTRIBUTE_LIFE_LEECH = 1 << 31,
	ITEM_ATTRIBUTE_MANA_LEECH = 1 << 32,
	ITEM_ATTRIBUTE_SPELL_DAMAGE = 1 << 33,
	ITEM_ATTRIBUTE_CRITICAL_HITE = 1 << 34, */
	
	ITEM_ATTRIBUTE_CUSTOM = 1U << 31
};

enum Statistics_t : uint8_t {
	STATISTIC_STRENGTH,
	STATISTIC_FIRST = STATISTIC_STRENGTH,
	STATISTIC_MAGIC,
	STATISTIC_DEXTERITY,
	STATISTIC_DEFENCE,
	STATISTIC_ENDURANCE,
...
enum ConditionParam_t {
	...
	CONDITION_PARAM_BUFF_INCREASEDAMAGE = 51,
	CONDITION_PARAM_BUFF_DECREASEDAMAGE = 52,
	CONDITION_PARAM_BUFF_INCREASEEXPERIENCE = 53,
	CONDITION_PARAM_BUFF_INCREASEHEALING = 54,
	CONDITION_PARAM_BUFF_INCREASELOOT = 55,
	CONDITION_PARAM_BUFF_DAMAGERECEIVED = 56,
	CONDITION_PARAM_BUFF_LIFELEECHAMOUNT = 57,
	CONDITION_PARAM_BUFF_LIFELEECHCHANCE = 58,
	CONDITION_PARAM_BUFF_MANALEECHAMOUNT = 59,
	CONDITION_PARAM_BUFF_MANALEECHCHANCE = 60,
	CONDITION_PARAM_STAT_CAPACITY = 61,
	CONDITION_PARAM_STAT_CAPACITYPERCENT = 62,
	CONDITION_PARAM_BUFF_DODGE = 63,
	CONDITION_PARAM_BUFF_INCREASESKILLRATE = 64,
	CONDITION_PARAM_BUFF_INCREASEATTACKSPEED = 65,
	CONDITION_PARAM_BUFF_DECREASEMELEEDAMAGE = 66
};
...
enum buffs_t {
	BUFF_INCREASEDAMAGE,
	BUFF_DECREASEDAMAGE,
	BUFF_INCREASEEXPERIENCE,
	BUFF_INCREASEHEALING,
	BUFF_INCREASELOOT,
	BUFF_DAMAGERECEIVED,
	BUFF_LIFELEECHAMOUNT,
	BUFF_LIFELEECHCHANCE,
	BUFF_MANALEECHAMOUNT,
	BUFF_MANALEECHCHANCE,
	BUFF_INCREASESKILLRATE,
	BUFF_DODGE,
	BUFF_DECREASEMELEEDAMAGE,
	BUFF_ATTACKSPEED,
	
	BUFF_FIRST = BUFF_INCREASEDAMAGE,
	BUFF_LAST = BUFF_ATTACKSPEED
};
