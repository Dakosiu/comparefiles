...
class MoveEvent final : public Event
{
	public:
		...
		std::vector<uint32_t> getMovementIdRange() {
			return movementIdRange;
		}
		void addMovementId(uint32_t id) {
			movementIdRange.emplace_back(id);
		}
	...
	private:
		...
		std::vector<uint32_t> movementIdRange;
