...
enum AttrTypes_t {
	...
	ATTR_EXTRA_ARMOR = 40,
	ATTR_EXTRA_DEFENSE = 41,
	ATTR_EXTRA_ATTACK = 42,
	ATTR_LIFE_LEECH = 43,
	ATTR_MANA_LEECH = 44,
	ATTR_SPELL_DAMAGE = 45,
	ATTR_CRITICAL_HIT = 46
};
...
class ItemAttributes
{
	...
	public:
		...
		const static uint32_t intAttributeTypes = ITEM_ATTRIBUTE_ACTIONID | ITEM_ATTRIBUTE_MOVEMENTID | ITEM_ATTRIBUTE_DATE | ITEM_ATTRIBUTE_WEIGHT | ITEM_ATTRIBUTE_ATTACK | ITEM_ATTRIBUTE_DEFENSE | ITEM_ATTRIBUTE_ARMOR
		| ITEM_ATTRIBUTE_SHOOTRANGE | ITEM_ATTRIBUTE_OWNER | ITEM_ATTRIBUTE_DURATION | ITEM_ATTRIBUTE_DECAYSTATE | ITEM_ATTRIBUTE_CORPSEOWNER | ITEM_ATTRIBUTE_CHARGES | ITEM_ATTRIBUTE_FLUIDTYPE
		| ITEM_ATTRIBUTE_DOORID | ITEM_ATTRIBUTE_KEYNUMBER | ITEM_ATTRIBUTE_KEYHOLENUMBER | ITEM_ATTRIBUTE_DOORQUESTNUMBER | ITEM_ATTRIBUTE_DOORQUESTVALUE | ITEM_ATTRIBUTE_DOORLEVEL | ITEM_ATTRIBUTE_CHESTQUESTNUMBER
        | ITEM_ATTRIBUTE_AUTOOPEN | ITEM_ATTRIBUTE_EXTRA_ARMOR | ITEM_ATTRIBUTE_EXTRA_DEFENSE | ITEM_ATTRIBUTE_EXTRA_ATTACK;
...
/* 		const ItemAttributes::CustomAttribute* getCustomAttribute(int64_t key) {
		...
		int32_t getAttack(bool extraAttack = true) const {
			uint32_t value = 0;
		...
		int32_t getExtraAttack() const {
			 uint32_t value = 0;
		     const ItemAttributes::CustomAttribute* attribute = getCustomAttribute("ITEM_STATISTIC_SYSTEM_INCREASE_ATTACK");			 
		...
		int32_t getArmor(bool extraArmor = true) const {
			uint32_t value = 0;
		...
		int32_t getExtraArmor() const {
			 uint32_t value = 0;
		     const ItemAttributes::CustomAttribute* attribute = getCustomAttribute("ITEM_STATISTIC_SYSTEM_INCREASE_ARMOR");			 
			 if (attribute != nullptr) {
				value += static_cast<uint32_t>(attribute->getInt());
			 }
		...
		int32_t getDefense(bool extraDefense = true) const {
			uint32_t value = 0;
		...
		int32_t getExtraDefense() const {
			 uint32_t value = 0;
		     const ItemAttributes::CustomAttribute* attribute = getCustomAttribute("ITEM_STATISTIC_SYSTEM_INCREASE_DEFENSE");			 
			 if (attribute != nullptr) {
				value += static_cast<uint32_t>(attribute->getInt());
			 }
