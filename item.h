...
public:
	...
	const static uint32_t intAttributeTypes = ITEM_ATTRIBUTE_ACTIONID | ITEM_ATTRIBUTE_MOVEMENTID 
			| ITEM_ATTRIBUTE_WEIGHT | ITEM_ATTRIBUTE_ATTACK | ITEM_ATTRIBUTE_DEFENSE | ITEM_ATTRIBUTE_ARMOR 
			| ITEM_ATTRIBUTE_SHOOTRANGE | ITEM_ATTRIBUTE_OWNER | ITEM_ATTRIBUTE_DURATION | ITEM_ATTRIBUTE_DECAYSTATE 
			| ITEM_ATTRIBUTE_CORPSEOWNER | ITEM_ATTRIBUTE_CHARGES | ITEM_ATTRIBUTE_FLUIDTYPE | ITEM_ATTRIBUTE_DOORID 
			| ITEM_ATTRIBUTE_KEYNUMBER | ITEM_ATTRIBUTE_KEYHOLENUMBER | ITEM_ATTRIBUTE_DOORQUESTNUMBER | ITEM_ATTRIBUTE_DOORQUESTVALUE 
			| ITEM_ATTRIBUTE_DOORLEVEL | ITEM_ATTRIBUTE_CHESTQUESTNUMBER;
