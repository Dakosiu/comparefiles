...
const phmap::flat_hash_map<std::string, ItemParseAttributes_t> ItemParseAttributesMap = {
	...
	{"refil", ITEM_PARSE_REFIL},
	{"damagereflection", ITEM_PARSE_DAMAGEREFLECTIONFLAT},
	{"damagereflectionpercent", ITEM_PARSE_DAMAGEREFLECTIONPERCENT},
...
class ItemParse : public Items
{
	...
	static void parseRefil(const std::string& tmpStrValue, pugi::xml_attribute valueAttribute, ItemType& itemType);
    static void parseDamageReflectionFlat(const std::string& tmpStrValue, pugi::xml_attribute valueAttribute, ItemType& itemType);
	static void parseDamageReflectionPercent(const std::string& tmpStrValue, pugi::xml_attribute valueAttribute, ItemType& itemType);
