...
class IOLoginData
{
	public:
		...
		static bool loadPlayerByIdEvent(Player* player, uint32_t id);
		
		static bool loadPlayerByName(Player* player, const std::string& name);
		static bool loadPlayer(Player* player, DBResult_ptr result);
		static bool loadPlayerEvent(Player* player, DBResult_ptr result);
		
		static bool savePlayer(Player* player);
		static bool savePlayerEvent(Player* player);
		//static bool savePlayerEvent(Player* player);
