...
struct DrawQueueItemImageWithShader : public DrawQueueItemTextureCoords {
    ...
    {};
    DrawQueueItemImageWithShader(CoordsBuffer& coords, const TexturePtr& texture, const Color& color, PainterShaderProgramPtr& shader) :
        DrawQueueItemTextureCoords(coords, texture, color), m_shaderProgram(shader)
    {};
