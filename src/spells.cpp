...
bool InstantSpell::playerCastInstant(Player* player, std::string& param, bool ignoreRequirements)
{
...
bool InstantSpell::canThrowSpell(const Creature* creature, const Creature* target) const
{
	...
	if (fromPos.z != toPos.z ||
			(range == -1 && !g_game.canThrowObjectTo(fromPos, toPos, checkLineOfSight, true, 16, 9)) ||
