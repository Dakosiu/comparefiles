...
class CreatureEvent final : public Event
{
	public:
		...
		void executeCreatureMove(Creature* creature, const Position& fromPos, const Position& toPos, ReturnValue& base, bool pathFinding);
		void executeDamageChange(Creature* creature, Creature* attacker, CombatDamage& damage);
