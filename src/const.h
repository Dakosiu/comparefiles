...
static constexpr int32_t NETWORKMESSAGE_MAXSIZE = 63590;
...
//[2012 - 2022];
static constexpr int32_t PSTRG_WINGS_RANGE_START = (PSTRG_RESERVED_RANGE_START + 2100);
static constexpr int32_t PSTRG_WINGS_RANGE_SIZE = 99;
static constexpr int32_t PSTRG_WINGS_CURRENTWINGS = (PSTRG_WINGS_RANGE_START + PSTRG_WINGS_RANGE_SIZE);
//[2023 - 2033];
static constexpr int32_t PSTRG_AURAS_RANGE_START = (PSTRG_RESERVED_RANGE_START + 2200);
static constexpr int32_t PSTRG_AURAS_RANGE_SIZE = 99;
static constexpr int32_t PSTRG_AURAS_CURRENTAURA = (PSTRG_AURAS_RANGE_START + PSTRG_AURAS_RANGE_SIZE);
//[2034 - 2044];
static constexpr int32_t PSTRG_SHADERS_RANGE_START = (PSTRG_RESERVED_RANGE_START + 2300);
static constexpr int32_t PSTRG_SHADERS_RANGE_SIZE = 99;
static constexpr int32_t PSTRG_SHADERS_CURRENTSHADER = (PSTRG_SHADERS_RANGE_START + PSTRG_SHADERS_RANGE_SIZE);
