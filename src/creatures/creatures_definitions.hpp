...
enum ConditionAttr_t {
	...
	CONDITIONATTR_LIFELEECHONHIT,
	CONDITIONATTR_MANALEECHONHIT,
	CONDITIONATTR_ABSORBPERCENT,
...
enum ConditionType_t {
	...
	CONDITION_SPECIALATTRIBUTES = 1 << 29,
...
enum ConditionParam_t {
	...
	CONDITION_PARAM_SKILL_ALL = 58,
	CONDITION_PARAM_SKILL_ALLPERCENT = 59,
	CONDITION_PARAM_SKILL_LIFE_LEECH_CUSTOM = 60,
	CONDITION_PARAM_SKILL_MANA_LEECH_CUSTOM = 61,
	...
	CONDITION_PARAM_SPECIAL_LIFELEECHONHIT = 72,
	CONDITION_PARAM_SPECIAL_MANALEECHONHIT = 73,
	CONDITION_PARAM_STAT_DAMAGEMITIGATION = 74,
	CONDITION_PARAM_STAT_EXTRADAMAGE = 75,
	CONDITION_PARAM_STAT_EXTRAHEALING = 76,
	CONDITION_PARAM_STAT_CAPACITY = 77,
	CONDITION_PARAM_SOUND_TICK = 78,
	CONDITION_PARAM_SOUND_ADD = 79,
	CONDITION_PARAM_BUFF_PHYSICAL_DAMAGE = 80,
	CONDITION_PARAM_BUFF_ENERGY_DAMAGE = 81,
	CONDITION_PARAM_BUFF_EARTH_DAMAGE = 82,
	CONDITION_PARAM_BUFF_FIRE_DAMAGE = 83,
	CONDITION_PARAM_BUFF_ICE_DAMAGE = 84,
	CONDITION_PARAM_BUFF_DEATH_DAMAGE = 85,
	CONDITION_PARAM_BUFF_PHYSICAL_DEFENSE = 86,
	CONDITION_PARAM_BUFF_ENERGY_DEFENSE = 87,
	CONDITION_PARAM_BUFF_EARTH_DEFENSE = 88,
	CONDITION_PARAM_BUFF_FIRE_DEFENSE = 89,
	CONDITION_PARAM_BUFF_ICE_DEFENSE = 90,
	CONDITION_PARAM_BUFF_DEATH_DEFENSE = 91
};
...
enum stats_t {
	...
	STAT_EXTRADAMAGE,
	STAT_EXTRAHEALING,
	STAT_DAMAGEMITIGATION,

	STAT_FIRST = STAT_MAXHITPOINTS,
	STAT_LAST = STAT_DAMAGEMITIGATION
};
...
enum CombatParam_t {
	...
	COMBAT_PARAM_MAXTARGETS,
	COMBAT_PARAM_MAXCHAINRANGE,
	COMBAT_PARAM_LIFELEECH,
	COMBAT_PARAM_MANALEECH,
	COMBAT_PARAM_ISBEAM,
	COMBAT_PARAM_CRITDAMAGE,
...
enum CallBackSpell_t {
	CALLBACK_SPELL_COOLDOWN,
	CALLBACK_SPELL_MANA,
	CALLBACK_SPELL_GROUP_COOLDOWN,
	CALLBACK_SPELL_SECONDARY_GROUP_COOLDOWN
};
...
struct CombatDamage {
	...
	uint16_t manaLeech;
	uint16_t critDamage;
	int16_t physAmplification;
	int16_t holyAmplification;
