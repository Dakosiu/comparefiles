...
class Game
{
	public:
		...
		void playerNewWalk(uint32_t playerId, Position pos, uint8_t flags, std::vector<Direction> listDir);
		...
		void startProgressBar(Creature* creature, int32_t duration, bool ltr = true);
		void startUpdateProgressBar(Creature* creature, uint8_t percent);
