...
class Game
{
	public:
		...
		void combatGetTypeInfo(CombatType_t combatType, Creature* target, uint8_t& color, uint8_t& effect);
		...
		void addAnimatedText(const std::string& message, const Position& pos, uint8_t color);
		static void addAnimatedText(const SpectatorVec& list, const std::string& message, const Position& pos, uint8_t color);
