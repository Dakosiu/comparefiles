...
class ProtocolGame final : public Protocol
{
	public:
		...
		void login(const std::string& name, uint32_t accountId, OperatingSystem_t operatingSystem, const std::string& getRoom = "", const std::string& getVocation = "");
	...
	private:
		...
		void sendProgressbar(uint32_t id, int32_t duration, bool ltr = true);
