...
enum ConditionParam_t {
	...
	CONDITION_PARAM_BUFF_DAMAGE = 56,
	CONDITION_PARAM_BUFF_ATTACKSPEED = 57,
	CONDITION_PARAM_BUFF_REFLECT = 58,
	CONDITION_PARAM_BUFF_DEFENSE = 59,
};
...
enum buffs_t {
	...
	BUFF_REFLECT,
	BUFF_DEFENSE,
	BUFF_FIRST = BUFF_DAMAGE,
	BUFF_LAST = BUFF_DEFENSE
};
...
struct Outfit_t {
    ...
    uint16_t lookAuraBack = 0;
	uint16_t lookAuraFront = 0;
