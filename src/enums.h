...
enum AdvancedAttributesType_t : uint8_t {
	ADVANCED_ATTRIBUTE_TYPE_STATS = 1,
    ADVANCED_ATTRIBUTE_TYPE_SKILL = 2,
    ADVANCED_ATTRIBUTE_TYPE_PLAYER_EFFECTS = 3,
    ADVANCED_ATTRIBUTE_TYPE_PLAYER_PROTECTION = 4,
    ADVANCED_ATTRIBUTE_TYPE_PLAYER_REFLECT = 5,
    ADVANCED_ATTRIBUTE_TYPE_ITEM = 6,
};
	
enum ItemAdvancedAttributes_t : uint8_t {
	ADVANCED_ATTRIBUTE_SKILL_NONE = 0,
	ADVANCED_ATTRIBUTE_SKILL_CLUB_FIGHTING = 1,
	ADVANCED_ATTRIBUTE_SKILL_SWORD_FIGHTING = 2,
	ADVANCED_ATTRIBUTE_SKILL_AXE_FIGHTING = 3,
	ADVANCED_ATTRIBUTE_SKILL_DISTANCE_FIGHTING = 4,
	ADVANCED_ATTRIBUTE_SKILL_SHIELDING = 5,
	ADVANCED_ATTRIBUTE_SKILL_FISHING = 6,
	ADVANCED_ATTRIBUTE_SKILL_LEVEL = 7,
	ADVANCED_ATTRIBUTE_SKILL_LAST = ADVANCED_ATTRIBUTE_SKILL_LEVEL,
	ADVANCED_ATTRIBUTE_SKILL_FIRST = ADVANCED_ATTRIBUTE_SKILL_CLUB_FIGHTING,
	
	ADVANCED_ATTRIBUTE_STAT_MAX_HEALTH = 9,
	ADVANCED_ATTRIBUTE_STAT_MAX_MANA = 10,
	ADVANCED_ATTRIBUTE_SKILL_MAGIC_LEVEL = 11,
	ADVANCED_ATTRIBUTE_STAT_LAST = ADVANCED_ATTRIBUTE_SKILL_MAGIC_LEVEL,
	ADVANCED_ATTRIBUTE_STAT_FIRST = ADVANCED_ATTRIBUTE_STAT_MAX_HEALTH,
	
	
	ADVANCED_ATTRIBUTE_ITEM_BONUS_COUNT = 12,
	ADVANCED_ATTRIBUTE_ITEM_ATTACK = 13,
	ADVANCED_ATTRIBUTE_ITEM_DEFENSE = 14,
	ADVANCED_ATTRIBUTE_ITEM_ARMOR = 15,
	ADVANCED_ATTRIBUTE_ITEM_SPEED = 16,
	ADVANCED_ATTRIBUTE_ITEM_HIT_CHANCE = 17,
	ADVANCED_ATTRIBUTE_ITEM_WEIGHT = 18,
	
	ADVANCED_ATTRIBUTE_PLAYER_PROTECTION_PHYSICAL = 19,
	ADVANCED_ATTRIBUTE_PLAYER_PROTECTION_FIRE = 20,
	ADVANCED_ATTRIBUTE_PLAYER_PROTECTION_ENERGY = 21,
	ADVANCED_ATTRIBUTE_PLAYER_PROTECTION_POISON = 22,
	ADVANCED_ATTRIBUTE_PLAYER_PROTECTION_LIFE_DRAIN = 23,
	ADVANCED_ATTRIBUTE_PLAYER_PROTECTION_MANA_DRAIN = 24,

	ADVANCED_ATTRIBUTE_PLAYER_REFLECT_PHYSICAL_AMOUNT = 25,
	ADVANCED_ATTRIBUTE_PLAYER_REFLECT_PHYSICAL_CHANCE = 26,
	ADVANCED_ATTRIBUTE_PLAYER_REFLECT_FIRE_AMOUNT = 27,
	ADVANCED_ATTRIBUTE_PLAYER_REFLECT_FIRE_CHANCE = 28,
	ADVANCED_ATTRIBUTE_PLAYER_REFLECT_ENERGY_AMOUNT = 29,
	ADVANCED_ATTRIBUTE_PLAYER_REFLECT_ENERGY_CHANCE = 30,
	ADVANCED_ATTRIBUTE_PLAYER_REFLECT_POISON_AMOUNT = 31,
	ADVANCED_ATTRIBUTE_PLAYER_REFLECT_POISON_CHANCE = 32,
	
	
	
	ADVANCED_ATTRIBUTE_PLAYER_HEALTH_REGENERATION = 33,
	ADVANCED_ATTRIBUTE_PLAYER_MANA_REGENERATION = 34,
	
	
	
	ADVANCED_ATTRIBUTE_PLAYER_HEALTH_HEALING = 35,
	ADVANCED_ATTRIBUTE_PLAYER_MANA_HEALING = 36,
	ADVANCED_ATTRIBUTE_PLAYER_HEALTH_ABSORB = 37,
	ADVANCED_ATTRIBUTE_PLAYER_MANA_ABSORB = 38,
	ADVANCED_ATTRIBUTE_PLAYER_CRITICAL_HIT_AMOUNT = 39,
	ADVANCED_ATTRIBUTE_PLAYER_CRITICAL_HIT_CHANCE = 40,
	ADVANCED_ATTRIBUTE_PLAYER_CRITICAL_SPELL_AMOUNT = 41,
	ADVANCED_ATTRIBUTE_PLAYER_CRITICAL_SPELL_CHANCE = 42,
	ADVANCED_ATTRIBUTE_PLAYER_ATTACK_INTERVAL = 43,
	
	ADVANCED_ATTRIBUTE_PLAYER_HEALTH_LEECH_AMOUNT = 44,
	ADVANCED_ATTRIBUTE_PLAYER_HEALTH_LEECH_CHANCE = 45,
	
	ADVANCED_ATTRIBUTE_PLAYER_MANA_LEECH_AMOUNT = 46,
	ADVANCED_ATTRIBUTE_PLAYER_MANA_LEECH_CHANCE = 47,
	
	ADVANCED_ATTRIBUTE_PLAYER_REFLECT_ELEMENTS_AMOUNT = 48,
	ADVANCED_ATTRIBUTE_PLAYER_REFLECT_ELEMENTS_CHANCE = 49,
	
	ADVANCED_ATTRIBUTE_PLAYER_PROTECTION_ELEMENTS = 50,
	ADVANCED_ATTRIBUTE_PLAYER_STATUS_STORE = 51,
	ADVANCED_ATTRIBUTE_PLAYER_STATUS_BURNING_AMOUNT = 52,
	ADVANCED_ATTRIBUTE_PLAYER_STATUS_BURNING_CHANCE = 53,
	ADVANCED_ATTRIBUTE_PLAYER_STATUS_POISON_AMOUNT = 54,
	ADVANCED_ATTRIBUTE_PLAYER_STATUS_POISON_CHANCE = 55,
	ADVANCED_ATTRIBUTE_PLAYER_STATUS_ELECTRIFY_AMOUNT = 56,
	ADVANCED_ATTRIBUTE_PLAYER_STATUS_ELECTRIFY_CHANCE = 57,
	ADVANCED_ATTRIBUTE_PLAYER_STATUS_BLEEDING_AMOUNT = 58,
	ADVANCED_ATTRIBUTE_PLAYER_STATUS_BLEEDING_CHANCE = 59,
	ADVANCED_ATTRIBUTE_PLAYER_STATUS_FREEZING_AMOUNT = 60,
	ADVANCED_ATTRIBUTE_PLAYER_STATUS_FREEZING_CHANCE = 61,
	
	
	ADVANCED_ATTRIBUTE_PLAYER_DODGE = 62,
	ADVANCED_ATTRIBUTE_PLAYER_ARROW_GUARD = 63,
	ADVANCED_ATTRIBUTE_PLAYER_PERFURATION = 64,
	ADVANCED_ATTRIBUTE_PLAYER_CRUSHING_BLOW = 65,
	
	ADVANCED_ATTRIBUTE_PLAYER_FIRST = ADVANCED_ATTRIBUTE_PLAYER_HEALTH_REGENERATION,
	ADVANCED_ATTRIBUTE_PLAYER_LAST = ADVANCED_ATTRIBUTE_PLAYER_CRUSHING_BLOW,
};

//const std::string& advanced_attributes_key = "ADVANCED_ATTRIBUTES";

/* enum AdvancedAttributes_skills : uint8_t {

};

enum AdvancedAttributes_stats {
...
/* enum ItemAdvancedAttributes_t : uint8_t {
	...
	ADVANCED_ATTRIBUTE_NONE = 0,
	ADVANCED_ATTRIBUTE_CLUB_FIGHTING = 1,
	ADVANCED_ATTRIBUTE_SWORD_FIGHTING = 2,
	ADVANCED_ATTRIBUTE_AXE_FIGHTING = 3,
	ADVANCED_ATTRIBUTE_DISTANCE_FIGHTING = 4,
	ADVANCED_ATTRIBUTE_SHIELDING = 5,
	ADVANCED_ATTRIBUTE_FISHING = 6,
	ADVANCED_ATTRIBUTE_MAGIC_LEVEL = 7,
	ADVANCED_ATTRIBUTE_LEVEL = 8,
	
	
	ADVANCED_ATTRIBUTE_ATTACK = 9,
	ADVANCED_ATTRIBUTE_DEFENSE = 11,
	ADVANCED_ATTRIBUTE_ARMOR = 12,
	...
	ADVANCED_ATTRIBUTE_MAX_HEALTH = 13,
	ADVANCED_ATTRIBUTE_MAX_MANA = 14,
	ADVANCED_ATTRIBUTE_HEALTH_REGENERATION = 15,
	ADVANCED_ATTRIBUTE_MANA_REGENERATION = 16,
	ADVANCED_ATTRIBUTE_HEALING = 17,
	ADVANCED_ATTRIBUTE_MANA_HEALING = 18,
	ADVANCED_ATTRIBUTE_ABSORB_HEALTH = 19,
	ADVANCED_ATTRIBUTE_ABSORB_MANA = 20,
	ADVANCED_ATTRIBUTE_SPEED = 21,
	ADVANCED_ATTRIBUTE_PROTECT_PHYSICAL = 22,
	ADVANCED_ATTRIBUTE_PROTECT_FIRE = 23,
	ADVANCED_ATTRIBUTE_PROTECT_ENERGY = 24,
	ADVANCED_ATTRIBUTE_PROTECT_POISON = 25,
	ADVANCED_ATTRIBUTE_PROTECT_HEALTH_DRAIN = 25,
	ADVANCED_ATTRIBUTE_PROTECT_MANA_DRAIN = 26,
	ADVANCED_ATTRIBUTE_PROTECT_ELEMENTS = 27,
	ADVANCED_ATTRIBUTE_REFLECT_PHYSICAL = 28,
	ADVANCED_ATTRIBUTE_CRITICAL_HIT = 29,
	ADVANCED_ATTRIBUTE_CRITICAL_SPELL = 30,
	ADVANCED_ATTRIBUTE_ATTACK_INTERVAL = 31,
	ADVANCED_ATTRIBUTE_LIFE_LEECH = 32,
	ADVANCED_ATTRIBUTE_MANA_LEECH = 33,
	ADVANCED_ATTRIBUTE_HIT_CHANCE = 33,
	ADVANCED_ATTRIBUTE_BURNING = 34,
	ADVANCED_ATTRIBUTE_POISON = 35,
	ADVANCED_ATTRIBUTE_ELECTRIFY = 36,
	ADVANCED_ATTRIBUTE_BLEEDING = 37,
	ADVANCED_ATTRIBUTE_FREEZE = 38,
	ADVANCED_ATTRIBUTE_DODGE = 39,
	ADVANCED_ATTRIBUTE_ARROW_GUARD = 40,
	ADVANCED_ATTRIBUTE_PERFURATION = 41,
	ADVANCED_ATTRIBUTE_CRUSHING_BLOW = 42,
	ADVANCED_ATTRIBUTE_DOUBLE_BASH = 43,
	ADVANCED_ATTRIBUTE_BERSERK = 44,
	ADVANCED_ATTRIBUTE_MOMENTUM = 45,
	ADVANCED_ATTRIBUTE_MITIGATION = 46,
	ADVANCED_ATTRIBUTE_VIBRANCY = 47,
	ADVANCED_ATTRIBUTE_WEIGHT = 48,
	ADVANCED_ATTRIBUTE_LAST = ADVANCED_ATTRIBUTE_WEIGHT,
}; */
