...
class LuaScriptInterface
{
	...
	private:
		...
		static int luaGameCreateMonsterLevel(lua_State* L);
		...
		static int luaItemGetExtraHealing(lua_State* L);
		static int luaItemSetExtraHealing(lua_State* L);
		static int luaItemGetProtectionAll(lua_State* L);
		...
		static int luaCreatureGetBonusHealth(lua_State* L);
		static int luaCreatureGetBonusMana(lua_State* L);
		...
		static int luaPlayerGetRewardBag(lua_State* L);
		...
		static int luaPlayerGetExtraHealth(lua_State* L);
		static int luaPlayerSetExtraHealth(lua_State* L);	

		static int luaPlayerGetExtraMana(lua_State* L);
		static int luaPlayerSetExtraMana(lua_State* L);

		static int luaPlayerGetExtraHealthAddon(lua_State* L);
		static int luaPlayerSetExtraHealthAddon(lua_State* L);	
		static int luaPlayerGetExtraManaAddon(lua_State* L);
		static int luaPlayerSetExtraManaAddon(lua_State* L);

		static int luaPlayerGetExtraHealthMount(lua_State* L);
		static int luaPlayerSetExtraHealthMount(lua_State* L);
		static int luaPlayerGetExtraManaMount(lua_State* L);
		static int luaPlayerSetExtraManaMount(lua_State* L);		

		static int luaPlayerGetExtraHealthRegeneration(lua_State* L);
		static int luaPlayerSetExtraHealthRegeneration(lua_State* L);

		static int luaPlayerGetExtraManaRegeneration(lua_State* L);
		static int luaPlayerSetExtraManaRegeneration(lua_State* L);

		//Dodge
		static int luaPlayerGetDodge(lua_State* L);
		static int luaPlayerSetDodge(lua_State* L);

		static int luaPlayerGetItemsBonusDamage(lua_State* L);

		//Reflect
		static int luaPlayerGetReflect(lua_State* L);
		static int luaPlayerGetReflectItems(lua_State* L);
		static int luaPlayerSetReflect(lua_State* L);

		static int luaPlayerGetSkillLevel(lua_State* L);
		static int luaPlayerSetSkillLevel(lua_State* L);
		static int luaPlayerSetSkillTries(lua_State* L);
		...
		static int luaPlayerSaveEvent(lua_State* L);
		static int luaPlayerLoadEvent(lua_State* L);
		...
		//? ExtraHealing
		static int luaPlayerGetExtraHealingBase(lua_State* L);
		static int luaPlayerSetExtraHealingBase(lua_State* L);

		//? protectionAll
		static int luaPlayerGetProtectionAllBase(lua_State* L);
		static int luaPlayerSetProtectionAllBase(lua_State* L);
		...
		static int luaVocationGetExtraHealing(lua_State* L);
		...
		static int luaItemTypeGetSlotsBonus(lua_State* L);
		...
		static int luaItemTypeGetExtraHealing(lua_State* L);	
		...
		static int luaMonsterTypeGetDescription(lua_State* L);
		static int luaMonsterTypeGetBossLevel(lua_State* L);
