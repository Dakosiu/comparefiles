...
class LuaScriptInterface
{
	...
	private:
		...
		static int luaGameCreateCustomMonster(lua_State* L);
		...
		static int luaCreatureSetCustomAttribute(lua_State* L);
		static int luaCreatureGetCustomAttribute(lua_State* L);
		static int luaCreatureRemoveCustomAttribute(lua_State* L);
		
		static int luaCreatureSetProgressBar(lua_State* L);
        static int luaCreatureSetUpdateProgressBar(lua_State* L);
		
		static int luaCreatureGetMaxShield(lua_State* L);
        static int luaCreatureSetShield(lua_State* L);
		...
		static int luaPlayerGetPoints(lua_State* L);
		static int luaPlayerSetPoints(lua_State* L);
		static int luaPlayerAddPoints(lua_State* L);
		static int luaPlayerRemovePoints(lua_State* L);
		static int luaPlayerGetDivision(lua_State* L);
		static int luaPlayerSetDivision(lua_State* L);
        
		static int luaPlayerGetBasicAttackAnimation(lua_State* L);
		...
		static int luaMonsterGetRealName(lua_State* L);
