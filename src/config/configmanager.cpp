...
bool ConfigManager::load()
{
	...
	boolean[LEGACY_MANASHIELD] = getGlobalBoolean(L, "LegacyMagicShield", false);
	...
	integer[MAX_PLAYERS_PER_IP] = getGlobalNumber(L, "maxPlayersSameIpAddress", 0);
	string[DELAYED_SAVE_SERVER] = getGlobalString(L, "delaySaveServer", "");
