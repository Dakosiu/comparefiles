...
class PlayerFunctions final : LuaScriptInterface {
	private:
		static void init(lua_State* L) {
			...
			registerMethod(L, "Player", "getWheelOfDestiny", PlayerFunctions::luaPlayerGetWheelOfDestiny);
			registerMethod(L, "Player", "getWheelOfDestinyPerk", PlayerFunctions::luaPlayerGetWheelOfDestinyPerk);
			registerMethod(L, "Player", "setWheelOfDestinyPerk", PlayerFunctions::luaPlayerSetWheelOfDestinyPerk);
            ...
            registerMethod(L, "Player", "addExperienceBonus", PlayerFunctions::luaPlayerAddExperienceBonus);
            registerMethod(L, "Player", "getExperienceBonus", PlayerFunctions::luaPlayerGetExperienceBonus);
			
			registerMethod(L, "Player", "canConnect", PlayerFunctions::luaPlayerCanConnect);
			registerMethod(L, "Player", "allowConnection", PlayerFunctions::luaPlayerAllowConnection);
			...
			registerMethod(L, "Player", "addOutfitAddonEx", PlayerFunctions::luaPlayerAddOutfitAddon);
			...
			registerMethod(L, "Player", "getGoldenAccountXpBoost", PlayerFunctions::luaPlayerGetGoldenAccountXpBoost);
			registerMethod(L, "Player", "setGoldenAccountXpBoost", PlayerFunctions::luaPlayerSetGoldenAccountXpBoost);
			...
			registerMethod(L, "Player", "removeFromWarList", PlayerFunctions::luaPlayerRemoveFromWarList);
		...
		static int luaPlayerGetWheelOfDestiny(lua_State* L);
		static int luaPlayerGetWheelOfDestinyPerk(lua_State* L);
		static int luaPlayerSetWheelOfDestinyPerk(lua_State* L);
        ...
        static int luaPlayerGetExperienceBonus(lua_State* L);
		static int luaPlayerAddExperienceBonus(lua_State* L);
		static int luaPlayerCanConnect(lua_State* L);
		static int luaPlayerAllowConnection(lua_State* L);
		...
		static int luaPlayerGetGoldenAccountXpBoost(lua_State *L);
		static int luaPlayerSetGoldenAccountXpBoost(lua_State *L);
        ...
        static int luaPlayerRemoveFromWarList(lua_State* L);
		static int luaPlayerAddToWarList(lua_State* L);
