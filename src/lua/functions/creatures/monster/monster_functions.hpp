...
class MonsterFunctions final : LuaScriptInterface {
	private:
			static void init(lua_State* L) {
                ...
                registerMethod(L, "Monster", "getRealName", MonsterFunctions::luaMonsterGetRealName);
				
				registerMethod(L, "Monster", "getLevel", MonsterFunctions::luaMonsterGetLevel);
				registerMethod(L, "Monster", "addLevel", MonsterFunctions::luaMonsterAddLevel);
				registerMethod(L, "Monster", "setLevel", MonsterFunctions::luaMonsterSetLevel);
				
				registerMethod(L, "Monster", "setFamiliar", MonsterFunctions::luaMonsterSetFamiliar);
				registerMethod(L, "Monster", "isFamiliar", MonsterFunctions::luaMonsterIsFamiliar);
		...
		static int luaMonsterAddLevel(lua_State *L);
