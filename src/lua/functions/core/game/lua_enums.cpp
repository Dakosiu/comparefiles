...
void LuaEnums::initCallbackSpellEnums(lua_State* L) {
	registerEnum(L, CALLBACK_SPELL_COOLDOWN);
	registerEnum(L, CALLBACK_SPELL_MANA);
	registerEnum(L, CALLBACK_SPELL_GROUP_COOLDOWN);
	registerEnum(L, CALLBACK_SPELL_SECONDARY_GROUP_COOLDOWN);
}
...
void LuaEnums::initConditionEnums(lua_State* L) {
	...
	registerEnum(L, CONDITION_SPECIALATTRIBUTES);
...
void LuaEnums::initConditionParamEnums(lua_State* L) {
	...
	registerEnum(L, CONDITION_PARAM_SKILL_LIFE_LEECH_CUSTOM);
	registerEnum(L, CONDITION_PARAM_SKILL_MANA_LEECH_CUSTOM);
	registerEnum(L, CONDITION_PARAM_STAT_CAPACITYPERCENT);
	...
	registerEnum(L, CONDITION_PARAM_SKILL_ALL);
	registerEnum(L, CONDITION_PARAM_SKILL_ALLPERCENT);
	...
	registerEnum(L, CONDITION_PARAM_SPECIAL_LIFELEECHONHIT);
	registerEnum(L, CONDITION_PARAM_SPECIAL_MANALEECHONHIT);
	registerEnum(L, CONDITION_PARAM_STAT_DAMAGEMITIGATION);
	registerEnum(L, CONDITION_PARAM_STAT_EXTRADAMAGE);
	registerEnum(L, CONDITION_PARAM_STAT_EXTRAHEALING);
	registerEnum(L, CONDITION_PARAM_STAT_CAPACITY);
	
	//buffs
	registerEnum(L, CONDITION_PARAM_BUFF_DAMAGEDEALT);
	registerEnum(L, CONDITION_PARAM_BUFF_DAMAGERECEIVED);
	registerEnum(L, CONDITION_PARAM_BUFF_PHYSICAL_DAMAGE);
	registerEnum(L, CONDITION_PARAM_BUFF_ENERGY_DAMAGE);
	registerEnum(L, CONDITION_PARAM_BUFF_EARTH_DAMAGE);
	registerEnum(L, CONDITION_PARAM_BUFF_FIRE_DAMAGE);
	registerEnum(L, CONDITION_PARAM_BUFF_ICE_DAMAGE);
	registerEnum(L, CONDITION_PARAM_BUFF_DEATH_DAMAGE);
	registerEnum(L, CONDITION_PARAM_BUFF_PHYSICAL_DEFENSE);
	registerEnum(L, CONDITION_PARAM_BUFF_ENERGY_DEFENSE);
	registerEnum(L, CONDITION_PARAM_BUFF_EARTH_DEFENSE);
	registerEnum(L, CONDITION_PARAM_BUFF_FIRE_DEFENSE);
	registerEnum(L, CONDITION_PARAM_BUFF_ICE_DEFENSE);
	registerEnum(L, CONDITION_PARAM_BUFF_DEATH_DEFENSE);
	
	registerEnum(L, BUFF_DAMAGEDEALT);
	registerEnum(L, BUFF_DAMAGERECEIVED);
	registerEnum(L, BUFF_PHYSICAL_DAMAGE);
    registerEnum(L, BUFF_ENERGY_DAMAGE);
	registerEnum(L, BUFF_EARTH_DAMAGE);
	registerEnum(L, BUFF_FIRE_DAMAGE);
	registerEnum(L, BUFF_ICE_DAMAGE);
	registerEnum(L, BUFF_DEATH_DAMAGE);
}
...
void LuaEnums::initConstMeEnums(lua_State* L) {
	...
	registerEnum(L, CONST_ME_GIFT_OF_LIFE);
	registerEnum(L, CONST_ME_AVATAR);
...
void LuaEnums::initItemIdEnums(lua_State* L) {
	...
	registerEnum(L, ITEM_DIAMOND_COIN);
