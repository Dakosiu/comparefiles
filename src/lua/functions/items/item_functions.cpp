...
int ItemFunctions::luaItemGetRefil(lua_State* L) {
	// item:getRefil()
	const Item* item = getUserdata<Item>(L, 1);
	if (!item) {
		reportErrorFunc(getErrorDesc(LUA_ERROR_ITEM_NOT_FOUND));
	...
	lua_pushnumber(L, item->getRefil());
	return 1;
}

int ItemFunctions::luaItemSetRefil(lua_State* L) {
	// item:setRefil(value)
	uint32_t value = getNumber<int32_t>(L, 2);
	Item* item = getUserdata<Item>(L, 1);
	if (item) {
		item->setRefil(value);
		pushBoolean(L, true);
...
int ItemFunctions::luaItemGetPhysicalResist(lua_State* L) {
	// item:getPhysicalResist()
	const Item* item = getUserdata<Item>(L, 1);
	if (!item) {
		reportErrorFunc(getErrorDesc(LUA_ERROR_ITEM_NOT_FOUND));
		pushBoolean(L, false);
	...
	lua_pushnumber(L, item->getPhysicalResist());
	return 1;
}

int ItemFunctions::luaItemAddPhysicalResist(lua_State* L) {
	// item:setHolyResist(value)
	uint32_t value = getNumber<int32_t>(L, 2);
	Item* item = getUserdata<Item>(L, 1);
	if (item) {
		item->addPhysicalResist(value);
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int ItemFunctions::luaItemGetEnergyResist(lua_State* L) {
	// item:getEnergyResist()
	const Item* item = getUserdata<Item>(L, 1);
	if (!item) {
		reportErrorFunc(getErrorDesc(LUA_ERROR_ITEM_NOT_FOUND));
		pushBoolean(L, false);
	...
	lua_pushnumber(L, item->getEnergyResist());
	return 1;
}

int ItemFunctions::luaItemAddEnergyResist(lua_State* L) {
	// item:setHolyResist(value)
	uint32_t value = getNumber<int32_t>(L, 2);
	Item* item = getUserdata<Item>(L, 1);
	if (item) {
		item->addEnergyResist(value);
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int ItemFunctions::luaItemGetEarthResist(lua_State* L) {
	// item:getEarthResist()
	const Item* item = getUserdata<Item>(L, 1);
	if (!item) {
		reportErrorFunc(getErrorDesc(LUA_ERROR_ITEM_NOT_FOUND));
	...
	lua_pushnumber(L, item->getEarthResist());
	return 1;
}

int ItemFunctions::luaItemAddEarthResist(lua_State* L) {
	// item:addEarthResist(value)
	uint32_t value = getNumber<int32_t>(L, 2);
	Item* item = getUserdata<Item>(L, 1);
	if (item) {
		item->addEarthResist(value);
...
int ItemFunctions::luaItemGetFireResist(lua_State* L) {
	// item:getFireResist()
	const Item* item = getUserdata<Item>(L, 1);
	if (!item) {
		reportErrorFunc(getErrorDesc(LUA_ERROR_ITEM_NOT_FOUND));
	...
	lua_pushnumber(L, item->getFireResist());
	return 1;
}

int ItemFunctions::luaItemAddFireResist(lua_State* L) {
	// item:addEarthResist(value)
	uint32_t value = getNumber<int32_t>(L, 2);
	Item* item = getUserdata<Item>(L, 1);
	if (item) {
		item->addFireResist(value);
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int ItemFunctions::luaItemGetUndefinedResist(lua_State* L) {
	// item:getFireResist()
	const Item* item = getUserdata<Item>(L, 1);
	if (!item) {
		reportErrorFunc(getErrorDesc(LUA_ERROR_ITEM_NOT_FOUND));
	...
	lua_pushnumber(L, item->getUndefinedResist());
	return 1;
}

int ItemFunctions::luaItemAddUndefinedResist(lua_State* L) {
	// item:addEarthResist(value)
	uint32_t value = getNumber<int32_t>(L, 2);
	Item* item = getUserdata<Item>(L, 1);
	if (item) {
		item->addUndefinedResist(value);
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int ItemFunctions::luaItemGetLifeDrainResist(lua_State* L) {
	// item:getFireResist()
	const Item* item = getUserdata<Item>(L, 1);
	if (!item) {
		reportErrorFunc(getErrorDesc(LUA_ERROR_ITEM_NOT_FOUND));
	...
	lua_pushnumber(L, item->getLifeDrainResist());
	return 1;
}

int ItemFunctions::luaItemAddLifeDrainResist(lua_State* L) {
	// item:addEarthResist(value)
	uint32_t value = getNumber<int32_t>(L, 2);
	Item* item = getUserdata<Item>(L, 1);
	if (item) {
		item->addLifeDrainResist(value);
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int ItemFunctions::luaItemGetManaDrainResist(lua_State* L) {
	// item:getFireResist()
	const Item* item = getUserdata<Item>(L, 1);
	if (!item) {
		reportErrorFunc(getErrorDesc(LUA_ERROR_ITEM_NOT_FOUND));
	...
	lua_pushnumber(L, item->getManaDrainResist());
	return 1;
}

int ItemFunctions::luaItemAddManaDrainResist(lua_State* L) {
	// item:addEarthResist(value)
	uint32_t value = getNumber<int32_t>(L, 2);
	Item* item = getUserdata<Item>(L, 1);
	if (item) {
...
int ItemFunctions::luaItemGetDrownResist(lua_State* L) {
	// item:getFireResist()
	const Item* item = getUserdata<Item>(L, 1);
	if (!item) {
		reportErrorFunc(getErrorDesc(LUA_ERROR_ITEM_NOT_FOUND));
	...
	lua_pushnumber(L, item->getDrownResist());
	return 1;
}

int ItemFunctions::luaItemAddDrownResist(lua_State* L) {
	// item:addEarthResist(value)
	uint32_t value = getNumber<int32_t>(L, 2);
	Item* item = getUserdata<Item>(L, 1);
	if (item) {
		item->addDrownResist(value);
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int ItemFunctions::luaItemGetIceResist(lua_State* L) {
	// item:getFireResist()
	const Item* item = getUserdata<Item>(L, 1);
	if (!item) {
		reportErrorFunc(getErrorDesc(LUA_ERROR_ITEM_NOT_FOUND));
	...
	lua_pushnumber(L, item->getIceResist());
	return 1;
}

int ItemFunctions::luaItemAddIceResist(lua_State* L) {
	// item:addEarthResist(value)
	uint32_t value = getNumber<int32_t>(L, 2);
	Item* item = getUserdata<Item>(L, 1);
	if (item) {
		item->addIceResist(value);
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int ItemFunctions::luaItemGetHolyResist(lua_State* L) {
	// item:getHolyResist()
	const Item* item = getUserdata<Item>(L, 1);
	if (!item) {
		reportErrorFunc(getErrorDesc(LUA_ERROR_ITEM_NOT_FOUND));
	...
	lua_pushnumber(L, item->getHolyResist());
	return 1;
}

int ItemFunctions::luaItemAddHolyResist(lua_State* L) {
	// item:setHolyResist(value)
	uint32_t value = getNumber<int32_t>(L, 2);
	Item* item = getUserdata<Item>(L, 1);
	if (item) {
		item->addHolyResist(value);
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int ItemFunctions::luaItemGetDeathResist(lua_State* L) {
	// item:getFireResist()
	const Item* item = getUserdata<Item>(L, 1);
	if (!item) {
		reportErrorFunc(getErrorDesc(LUA_ERROR_ITEM_NOT_FOUND));
	...
	lua_pushnumber(L, item->getDeathResist());
	return 1;
}

int ItemFunctions::luaItemAddDeathResist(lua_State* L) {
	// item:addEarthResist(value)
	uint32_t value = getNumber<int32_t>(L, 2);
	Item* item = getUserdata<Item>(L, 1);
	if (item) {
		item->addDeathResist(value);
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
