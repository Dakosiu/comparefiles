...
class ItemFunctions final : LuaScriptInterface {
	public:
		static void init(lua_State* L) {
            ...
            registerMethod(L, "Item", "getRefil", ItemFunctions::luaItemGetRefil);
			registerMethod(L, "Item", "setRefil", ItemFunctions::luaItemSetRefil);

			registerMethod(L, "Item", "getPhysicalResist", ItemFunctions::luaItemGetPhysicalResist);
			registerMethod(L, "Item", "addPhysicalResist", ItemFunctions::luaItemAddPhysicalResist);
			
			registerMethod(L, "Item", "getEnergyResist", ItemFunctions::luaItemGetEnergyResist);
			registerMethod(L, "Item", "addEnergyResist", ItemFunctions::luaItemAddEnergyResist);
						
			registerMethod(L, "Item", "getEarthResist", ItemFunctions::luaItemGetEarthResist);
			registerMethod(L, "Item", "addEarthResist", ItemFunctions::luaItemAddEarthResist);
			
			registerMethod(L, "Item", "getFireResist", ItemFunctions::luaItemGetFireResist);
			registerMethod(L, "Item", "addFireResist", ItemFunctions::luaItemAddFireResist);

			registerMethod(L, "Item", "getUndefinedResist", ItemFunctions::luaItemGetUndefinedResist);
			registerMethod(L, "Item", "addUndefinedResist", ItemFunctions::luaItemAddUndefinedResist);
			
			registerMethod(L, "Item", "getLifeDrainResist", ItemFunctions::luaItemGetLifeDrainResist);
			registerMethod(L, "Item", "addLifeDrainResist", ItemFunctions::luaItemAddLifeDrainResist);			

			registerMethod(L, "Item", "getManaDrainResist", ItemFunctions::luaItemGetManaDrainResist);
			registerMethod(L, "Item", "addManaDrainResist", ItemFunctions::luaItemAddManaDrainResist);	
			
			//registerMethod(L, "Item", "getHealing", ItemFunctions::luaItemGetHealing);

			registerMethod(L, "Item", "getDrownResist", ItemFunctions::luaItemGetDrownResist);
			registerMethod(L, "Item", "addDrownResist", ItemFunctions::luaItemAddDrownResist);			

			registerMethod(L, "Item", "getIceResist", ItemFunctions::luaItemGetIceResist);
			registerMethod(L, "Item", "addIceResist", ItemFunctions::luaItemAddIceResist);	
			
			registerMethod(L, "Item", "getHolyResist", ItemFunctions::luaItemGetHolyResist);
			registerMethod(L, "Item", "addHolyResist", ItemFunctions::luaItemAddHolyResist);
			
			registerMethod(L, "Item", "getDeathResist", ItemFunctions::luaItemGetDeathResist);
			registerMethod(L, "Item", "addDeathResist", ItemFunctions::luaItemAddDeathResist);				
	...
	private:
		...
		static int luaItemGetRefil(lua_State* L);
		static int luaItemSetRefil(lua_State* L);

		static int luaItemGetPhysicalResist(lua_State* L);
		static int luaItemAddPhysicalResist(lua_State* L);
		static int luaItemGetEnergyResist(lua_State* L);
		static int luaItemAddEnergyResist(lua_State* L);
		static int luaItemGetEarthResist(lua_State* L);
		static int luaItemAddEarthResist(lua_State* L);
		static int luaItemGetFireResist(lua_State* L);
		static int luaItemAddFireResist(lua_State* L);
		static int luaItemGetUndefinedResist(lua_State* L);
		static int luaItemAddUndefinedResist(lua_State* L);	
		static int luaItemGetLifeDrainResist(lua_State* L);
		static int luaItemAddLifeDrainResist(lua_State* L);
		static int luaItemGetManaDrainResist(lua_State* L);
		static int luaItemAddManaDrainResist(lua_State* L);
		static int luaItemGetHealing(lua_State* L);
		static int luaItemGetDrownResist(lua_State* L);
		static int luaItemAddDrownResist(lua_State* L);
		static int luaItemGetIceResist(lua_State* L);
		static int luaItemAddIceResist(lua_State* L);
		static int luaItemGetHolyResist(lua_State* L);
		static int luaItemAddHolyResist(lua_State* L);
		static int luaItemGetDeathResist(lua_State* L);
		static int luaItemAddDeathResist(lua_State* L);		
};
