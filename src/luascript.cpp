...
void LuaScriptInterface::registerFunctions()
{
	...
	registerEnum(CONST_ANI_MISSILE_55)
	registerEnum(CONST_ANI_MISSILE_56)
	registerEnum(CONST_ANI_MISSILE_57)
	registerEnum(CONST_ANI_MISSILE_58)
	registerEnum(CONST_ANI_MISSILE_59)
	registerEnum(CONST_ANI_MISSILE_60)
	registerEnum(CONST_ANI_MISSILE_61)
	registerEnum(CONST_ANI_MISSILE_62)
	registerEnum(CONST_ANI_MISSILE_63)
	registerEnum(CONST_ANI_MISSILE_64)
	registerEnum(CONST_ANI_MISSILE_65)
	registerEnum(CONST_ANI_MISSILE_66)
	registerEnum(CONST_ANI_MISSILE_67)
	registerEnum(CONST_ANI_MISSILE_68)
	registerEnum(CONST_ANI_MISSILE_69)
	registerEnum(CONST_ANI_MISSILE_70)
	registerEnum(CONST_ANI_MISSILE_71)
	registerEnum(CONST_ANI_MISSILE_72)
	registerEnum(CONST_ANI_MISSILE_73)
	registerEnum(CONST_ANI_MISSILE_74)
	registerEnum(CONST_ANI_MISSILE_75)
	registerEnum(CONST_ANI_MISSILE_76)
	registerEnum(CONST_ANI_MISSILE_77)
	registerEnum(CONST_ANI_MISSILE_78)
	registerEnum(CONST_ANI_MISSILE_79)
	registerEnum(CONST_ANI_MISSILE_80)
	registerEnum(CONST_ANI_MISSILE_81)
	registerEnum(CONST_ANI_MISSILE_82)
	registerEnum(CONST_ANI_MISSILE_83)
	registerEnum(CONST_ANI_MISSILE_84)
	registerEnum(CONST_ANI_MISSILE_85)
	registerEnum(CONST_ANI_MISSILE_86)
	registerEnum(CONST_ANI_MISSILE_87)
	registerEnum(CONST_ANI_MISSILE_88)
	registerEnum(CONST_ANI_MISSILE_89)
	registerEnum(CONST_ANI_MISSILE_90)
	registerEnum(CONST_ANI_MISSILE_91)
	registerEnum(CONST_ANI_MISSILE_92)
	registerEnum(CONST_ANI_MISSILE_93)
	...
	registerEnum(ITEM_ATTRIBUTE_EXTRAHEALING)
	registerEnum(ITEM_ATTRIBUTE_DODGE)
	registerEnum(ITEM_ATTRIBUTE_SLOTS)
	registerEnum(ITEM_ATTRIBUTE_BONUSDAMAGE)
	...
	registerEnum(ZONE_NOPVP)// condition:setOutfit(outfit)
	...
	registerMethod("Game", "createMonsterLevel", LuaScriptInterface::luaGameCreateMonsterLevel);
	...
	registerMethod("Item", "getExtraHealing", LuaScriptInterface::luaItemGetExtraHealing);
    registerMethod("Item", "setExtraHealing", LuaScriptInterface::luaItemSetExtraHealing);

    registerMethod("Item", "getProtectionAll", LuaScriptInterface::luaItemGetProtectionAll);
	...
	registerMethod("Creature", "getBonusHealth", LuaScriptInterface::luaCreatureGetBonusHealth);
	registerMethod("Creature", "getBonusMana", LuaScriptInterface::luaCreatureGetBonusMana);
	...
	registerMethod("Player", "getRewardBag", LuaScriptInterface::luaPlayerGetRewardBag);
	...
	registerMethod("Player", "setSkillTries", LuaScriptInterface::luaPlayerSetSkillTries);
	...
	registerMethod("Player", "addOutfitAddonEx", LuaScriptInterface::luaPlayerAddOutfitAddon);
	...
	registerMethod("Player", "addMountEx", LuaScriptInterface::luaPlayerAddMount);
	...
	registerMethod("Player", "saveEvent", LuaScriptInterface::luaPlayerSaveEvent);
	registerMethod("Player", "loadEvent", LuaScriptInterface::luaPlayerLoadEvent);
	...
	registerMethod("Player", "getExtraHealth", LuaScriptInterface::luaPlayerGetExtraHealth);
    registerMethod("Player", "setExtraHealth", LuaScriptInterface::luaPlayerSetExtraHealth);
	registerMethod("Player", "getExtraMana", LuaScriptInterface::luaPlayerGetExtraMana);
    registerMethod("Player", "setExtraMana", LuaScriptInterface::luaPlayerSetExtraMana);

	registerMethod("Player", "getExtraHealthAddon", LuaScriptInterface::luaPlayerGetExtraHealthAddon);
    registerMethod("Player", "setExtraHealthAddon", LuaScriptInterface::luaPlayerSetExtraHealthAddon);
	registerMethod("Player", "getExtraManaAddon", LuaScriptInterface::luaPlayerGetExtraManaAddon);
    registerMethod("Player", "setExtraManaAddon", LuaScriptInterface::luaPlayerSetExtraManaAddon);

	registerMethod("Player", "getExtraHealthMount", LuaScriptInterface::luaPlayerGetExtraHealthMount);
    registerMethod("Player", "setExtraHealthMount", LuaScriptInterface::luaPlayerSetExtraHealthMount);
	registerMethod("Player", "getExtraManaMount", LuaScriptInterface::luaPlayerGetExtraManaMount);
    registerMethod("Player", "setExtraManaMount", LuaScriptInterface::luaPlayerSetExtraManaMount);

	registerMethod("Player", "getExtraHealthRegeneration", LuaScriptInterface::luaPlayerGetExtraHealthRegeneration);
    registerMethod("Player", "setExtraHealthRegeneration", LuaScriptInterface::luaPlayerSetExtraHealthRegeneration);
	registerMethod("Player", "getExtraManaRegeneration", LuaScriptInterface::luaPlayerGetExtraManaRegeneration);
    registerMethod("Player", "setExtraManaRegeneration", LuaScriptInterface::luaPlayerSetExtraManaRegeneration);
	
	//? Dodge
	registerMethod("Player", "getDodge", LuaScriptInterface::luaPlayerGetDodge);
	registerMethod("Player", "setDodge", LuaScriptInterface::luaPlayerSetDodge);

	registerMethod("Player", "getItemsBonusDamage", LuaScriptInterface::luaPlayerGetItemsBonusDamage);

	//? Reflect
	registerMethod("Player", "getReflect", LuaScriptInterface::luaPlayerGetReflect);
	registerMethod("Player", "getReflectItems", LuaScriptInterface::luaPlayerGetReflectItems);
	registerMethod("Player", "setReflect", LuaScriptInterface::luaPlayerSetReflect);

	//? ExtraHealing
	registerMethod("Player", "getExtraHealingBase", LuaScriptInterface::luaPlayerGetExtraHealingBase);
	registerMethod("Player", "setExtraHealingBase", LuaScriptInterface::luaPlayerSetExtraHealingBase);

	//? ProtectionAll
	registerMethod("Player", "getProtectionAllBase", LuaScriptInterface::luaPlayerGetProtectionAllBase);
	registerMethod("Player", "setProtectionAllBase", LuaScriptInterface::luaPlayerSetProtectionAllBase);
	...
	registerMethod("Vocation", "getExtraHealing", LuaScriptInterface::luaVocationGetExtraHealing);
   ...
   registerMethod("ItemType", "getExtraHealing", LuaScriptInterface::luaItemTypeGetExtraHealing);
	registerMethod("ItemType", "getSlotsBonus", LuaScriptInterface::luaItemTypeGetSlotsBonus);
	...
	registerMethod("MonsterType", "getDescription", LuaScriptInterface::luaMonsterTypeGetDescription);
	registerMethod("MonsterType", "getBossLevel", LuaScriptInterface::luaMonsterTypeGetBossLevel);
...
int LuaScriptInterface::luaGameCreateMonsterLevel(lua_State* L)
{
	//placeCreatureWithLevel(Creature* creature, const Position& pos, bool extendedPos /*=false*/, bool forced /*= false*/, int32_t level);
	Monster* monster = Monster::createMonster(getString(L, 1));
	if (!monster) {
		lua_pushnil(L);
		return 1;
	...
	bool extended = getBoolean(L, 3, false);
	bool force = getBoolean(L, 4, false);
	uint32_t level = getNumber<uint32_t>(L, 5);
	if (g_events->eventMonsterOnSpawn(monster, position, false, true) || force, level) {
		if (g_game.placeCreatureWithLevel(monster, position, extended, force, level)) {
			pushUserdata<Monster>(L, monster);
			setMetatable(L, -1, "Monster");
		} else {
			delete monster;
...
int LuaScriptInterface::luaItemMoveTo(lua_State* L)
{
	...
	uint32_t flags = getNumber<uint32_t>(L, 3, FLAG_IGNOREBLOCKITEM | FLAG_IGNOREBLOCKCREATURE | FLAG_IGNORENOTMOVEABLE);
...
int LuaScriptInterface::luaItemGetExtraHealing(lua_State* L)
{
	// item:getExtraHealing()
	Item* item = getUserdata<Item>(L, 1);
	if (item) {
		lua_pushnumber(L, item->getExtraHealing());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemGetProtectionAll(lua_State* L)
{
	// item:getProtectionAll()
	Item* item = getUserdata<Item>(L, 1);
	if (item) {
		lua_pushnumber(L, item->getProtectionAll());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemSetExtraHealing(lua_State* L)
{
	// item:setExtraHealing(value)	
	Item* item = getUserdata<Item>(L, 1);
	itemAttrTypes attribute;
	attribute = ITEM_ATTRIBUTE_EXTRAHEALING;
	if (item) {
		item->setIntAttr(attribute, getNumber<int32_t>(L, 2));
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaCreatureGetBonusHealth(lua_State* L)
{
	// creature:getBonusHealth()
	const Creature* creature = getUserdata<const Creature>(L, 1);
	if (creature) {
		lua_pushnumber(L, creature->getBonusHealth());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaCreatureGetBonusMana(lua_State* L)
{
	// creature:getBonusMana()
	const Creature* creature = getUserdata<const Creature>(L, 1);
	if (creature) {
		lua_pushnumber(L, creature->getBonusMana());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPlayerGetRewardBag(lua_State* L)
{
	// player:getRewardBag(depotId[, autoCreate = false])
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		lua_pushnil(L);
		return 1;
	...
	//uint32_t depotId = getNumber<uint32_t>(L, 2);
	bool autoCreate = getBoolean(L, 3, false);
	DepotChest* depotChest = player->getRewardBag(99, autoCreate);
	if (depotChest) {
		player->setLastDepotId(99); // FIXME: workaround for #2251
		pushUserdata<Item>(L, depotChest);
		setItemMetatable(L, -1, depotChest);
	} else {
		pushBoolean(L, false);
...
int LuaScriptInterface::luaPlayerGetExtraHealth(lua_State* L)
{
	// player:getExtraHealth()
	const Player* player = getUserdata<const Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getExtraHealth());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerSetExtraHealth(lua_State* L)
{
	// player:setExtraHealth(value)
	Player* player = getPlayer(L, 1);
	if (player) {
		player->extraHealth = getNumber<int32_t>(L, 2);
		player->sendStats();
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPlayerGetExtraHealthAddon(lua_State* L)
{
	// player:getExtraHealthAddon()
	const Player* player = getUserdata<const Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getExtraHealthAddon());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerSetExtraHealthAddon(lua_State* L)
{
	// player:setExtraHealthAddon(value)
	Player* player = getPlayer(L, 1);
	if (player) {
		player->extraHealthAddon = getNumber<int32_t>(L, 2);
		player->sendStats();
		pushBoolean(L, true);
	}
	else {
...
int LuaScriptInterface::luaPlayerGetExtraManaAddon(lua_State* L)
{
	// player:getExtraManaAddon()
	const Player* player = getUserdata<const Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getExtraManaAddon());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerSetExtraManaAddon(lua_State* L)
{
	// player:setExtraManaAddon(value)
	Player* player = getPlayer(L, 1);
	if (player) {
		player->extraManaAddon = getNumber<int32_t>(L, 2);
		player->sendStats();
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPlayerGetExtraHealthMount(lua_State* L)
{
	// player:getExtraHealthMount()
	const Player* player = getUserdata<const Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getExtraHealthMount());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerSetExtraHealthMount(lua_State* L)
{
	// player:setExtraHealthMount(value)
	Player* player = getPlayer(L, 1);
	if (player) {
		player->extraHealthMount = getNumber<int32_t>(L, 2);
		player->sendStats();
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPlayerGetExtraManaMount(lua_State* L)
{
	// player:getExtraManaMount()
	const Player* player = getUserdata<const Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getExtraManaMount());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerSetExtraManaMount(lua_State* L)
{
	// player:setExtraManaMount(value)
	Player* player = getPlayer(L, 1);
	if (player) {
		player->extraManaMount = getNumber<int32_t>(L, 2);
		player->sendStats();
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPlayerGetExtraMana(lua_State* L)
{
	// player:getExtraMana()
	const Player* player = getUserdata<const Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getExtraMana());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerSetExtraMana(lua_State* L)
{
	// player:setExtraMana(value)
	Player* player = getPlayer(L, 1);
	if (player) {
		player->extraMana = getNumber<int32_t>(L, 2);
		player->sendStats();
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPlayerGetExtraHealthRegeneration(lua_State* L)
{
	// player:getExtraHealthRegeneration()
	const Player* player = getUserdata<const Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getExtraHealthRegeneration());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerSetExtraHealthRegeneration(lua_State* L)
{
	// player:setExtraHealthRegeneration(value)
	Player* player = getPlayer(L, 1);
	if (player) {
		player->extraHealthRegeneration = getNumber<int32_t>(L, 2);
		player->sendStats();
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPlayerGetExtraManaRegeneration(lua_State* L)
{
	// player:getExtraManaRegeneration()
	const Player* player = getUserdata<const Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getExtraManaRegeneration());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerSetExtraManaRegeneration(lua_State* L)
{
	// player:setExtraManaRegeneration(value)
	Player* player = getPlayer(L, 1);
	if (player) {
		player->extraManaRegeneration = getNumber<int32_t>(L, 2);
		player->sendStats();
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
...
{
	// player:setSkillLevel(skillType, value)
	Player* player = getUserdata<Player>(L, 1);
	skills_t skillType = getNumber<skills_t>(L, 2);
	if (player) {
		player->skills[skillType].level = getNumber<uint32_t>(L, 3);
		player->sendSkills();
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
...
{
	// player:setManaSpent(value)
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		uint32_t value = getNumber<uint32_t>(L, 2);
		player->manaSpent = value;
		player->sendStats();
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPlayerSetSkillTries(lua_State* L)
{
	// player:setSkillTries(skillType, value)
	Player* player = getUserdata<Player>(L, 1);
	skills_t skillType = getNumber<skills_t>(L, 2);
	if (player) {
		player->skills[skillType].tries = getNumber<uint64_t>(L, 3);
		player->sendSkills();
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
...
{
	// player:addOutfitAddonEx(lookType, addon)
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
...
int LuaScriptInterface::luaPlayerSaveEvent(lua_State* L)
{
	// player:saveEvent()
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		player->loginPosition = player->getPosition();
		player->setSaveStatement();
		pushBoolean(L, IOLoginData::savePlayerEvent(player));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerLoadEvent(lua_State* L)
{
	// player:loadEvent()
	Player* player = getUserdata<Player>(L, 1);
	uint32_t id = getNumber<uint32_t>(L, 2); 
	...
	if (player) {
		player->loginPosition = player->getPosition();
		pushBoolean(L, IOLoginData::loadPlayerByIdEvent(player, id));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetExtraHealingBase(lua_State* L)
{
	// player:getExtraHealingBase()
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getExtraHealingBase());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerSetExtraHealingBase(lua_State* L)
{
	// player:setExtraHealingBase(value)
    Player* player = getPlayer(L, 1);
    if (player) {
        player->extraHealingBase = getNumber<int32_t>(L, 2);
        player->sendStats();
        pushBoolean(L, true);
    } else {
        lua_pushnil(L);
...
int LuaScriptInterface::luaPlayerGetProtectionAllBase(lua_State* L)
{
	// player:getProtectionAllBase()
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getProtectionAllBase());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerSetProtectionAllBase(lua_State* L)
{
	// player:setProtectionAllBase(value)
    Player* player = getPlayer(L, 1);
    if (player) {
        player->protectionAllBase = getNumber<int32_t>(L, 2);
        player->sendStats();
        pushBoolean(L, true);
    } else {
        lua_pushnil(L);
...
int LuaScriptInterface::luaVocationGetExtraHealing(lua_State* L)
{
	// vocation:getExtraHealing()
	Vocation* vocation = getUserdata<Vocation>(L, 1);
	if (vocation) {
		lua_pushnumber(L, vocation->getExtraHealing());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetReflect(lua_State* L)
{
	...
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getReflection());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPlayerGetReflectItems(lua_State* L)
{
	// player:getReflectItems()
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getReflectItems());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPlayerSetReflect(lua_State* L)
{
	// player:setReflect(value)
	Player* player = getPlayer(L, 1);
	if (player) {
		player->reflection = getNumber<double>(L, 2);
		player->sendStats();
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaItemTypeGetSlotsBonus(lua_State* L)
{
	// itemType:getSlotsBonus()
	const ItemType* itemType = getUserdata<const ItemType>(L, -1);
	if (itemType) {
		lua_pushnumber(L, itemType->slots);
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPlayerGetDodge(lua_State* L)
{
	...
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getDodge());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPlayerGetItemsBonusDamage(lua_State* L)
{
	// player:getDodgeBase()
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getItemsBonusDamage());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPlayerSetDodge(lua_State* L)
{
	// player:setDodge(value)
	Player* player = getPlayer(L, 1);
	if (player) {
		player->Dodge = getNumber<double>(L, 2);
		player->sendStats();
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaItemTypeGetExtraHealing(lua_State* L)
{
    // itemType:getExtraHealing()
    const ItemType* itemType = getUserdata<const ItemType>(L, -1);
    if (itemType) {
        lua_pushnumber(L, itemType->extrahealing);
    } else {
        lua_pushnil(L);
    }
    return 1;
...
{
	// get: monsterType:useRewardChest()
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, monsterType->info.rewardChest);
		} else {
			monsterType->info.rewardChest = getBoolean(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaMonsterTypeGetBossLevel(lua_State* L)
{
	// monsterType:getBossLevel()
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		lua_pushnumber(L, monsterType->info.bosslevel);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaMonsterTypeGetDescription(lua_State* L)
{
	// monsterType:getDescription()
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		pushString(L, monsterType->info.description);
	} else {
		lua_pushnil(L);
	}
	return 1;
